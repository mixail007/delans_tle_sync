...
// Возвращаени имя значения для API по значению перечисления.
//
// Параметры:
//  Значение - ПеречислениеСсылка.ПраваПользователяПриложения - значение перечисления для получения имени знаяения для API
// 
// Возвращаемое значение:
