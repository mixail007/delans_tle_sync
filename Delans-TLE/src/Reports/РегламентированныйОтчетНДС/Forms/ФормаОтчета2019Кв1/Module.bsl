...
Процедура ПроверкаКС_1_7(СтруктураРезультата)
	...
	ИменаПоказателейИтога.Вставить("Р03С118", "П000300011805");
	
	ИменаПоказателейСуммы = Новый Структура;
	ИменаПоказателейСуммы.Вставить("Р03С010", "П000300001005");
	ИменаПоказателейСуммы.Вставить("Р03С020", "П000300002005");
	ИменаПоказателейСуммы.Вставить("Р03С030", "П000300003005");
	ИменаПоказателейСуммы.Вставить("Р03С040", "П000300004005");
	ИменаПоказателейСуммы.Вставить("Р03С041", "П000300004105");
	ИменаПоказателейСуммы.Вставить("Р03С042", "П000300004205");
	ИменаПоказателейСуммы.Вставить("Р03С045", "П000300004505");
	ИменаПоказателейСуммы.Вставить("Р03С046", "П000300004605");
	ИменаПоказателейСуммы.Вставить("Р03С050", "П000300005005");
	ИменаПоказателейСуммы.Вставить("Р03С060", "П000300006005");
	ИменаПоказателейСуммы.Вставить("Р03С070", "П000300007005");
	ИменаПоказателейСуммы.Вставить("Р03С080", "П000300008005");
	ИменаПоказателейСуммы.Вставить("Р03С105", "П000300010505");
	ИменаПоказателейСуммы.Вставить("Р03С109", "П000300010905");
	ИменаПоказателейСуммы.Вставить("Р03С110", "П000300011005");
	ИменаПоказателейСуммы.Вставить("Р03С115", "П000300011505");
	...
	Для каждого Показатель Из ПоказателиСуммы Цикл
		РасчетнаяСумма = РасчетнаяСумма + Показатель.Значение.Значение;
	КонецЦикла;
	
	Настройки.ЭтоОшибка = НЕ ПоказателиИтога.Р03С118.Значение = РасчетнаяСумма;
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
		ПоказателиИтога.Р03С118.Значение, РасчетнаяСумма);
...
Процедура ПроверкаКС_1_8(СтруктураРезультата)
	...
	ИменаПоказателейИтога = Новый Структура;
	ИменаПоказателейИтога.Вставить("Р03С190", "П000300019003");
	
	ИменаПоказателейСуммы = Новый Структура;
	ИменаПоказателейСуммы.Вставить("Р03С120", "П000300012003");
	ИменаПоказателейСуммы.Вставить("Р03С130", "П000300013003");
	ИменаПоказателейСуммы.Вставить("Р03С135", "П000300013503");
	ИменаПоказателейСуммы.Вставить("Р03С140", "П000300014003");
	ИменаПоказателейСуммы.Вставить("Р03С150", "П000300015003");
	ИменаПоказателейСуммы.Вставить("Р03С160", "П000300016003");
	ИменаПоказателейСуммы.Вставить("Р03С170", "П000300017003");
	ИменаПоказателейСуммы.Вставить("Р03С180", "П000300018003");
	ИменаПоказателейСуммы.Вставить("Р03С185", "П000300018503");
	...
	Настройки.ЭтоОшибка = НЕ ПоказателиИтога.Р03С190.Значение = РасчетнаяСумма;
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
		ПоказателиИтога.Р03С190.Значение, РасчетнаяСумма);
...
Процедура ПроверкаКС_1_9(СтруктураРезультата)
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р03С200"		, "П000300020003");
	...
	РасчетнаяСумма = Макс(Показатели.Р03С118.Значение - Показатели.Р03С190.Значение, 0);
	Настройки.ЭтоОшибка = НЕ Показатели.Р03С200.Значение = РасчетнаяСумма;
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
		Показатели.Р03С200.Значение, Показатели.Р03С118.Значение, Показатели.Р03С190.Значение, РасчетнаяСумма);
...
Процедура ПроверкаКС_1_10(СтруктураРезультата)
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р03С210"		, "П000300021003");
	ИменаПоказателей.Вставить("Р03С190"		, "П000300019003");
	ИменаПоказателей.Вставить("Р03С118"		, "П000300011805");
	...
	РасчетнаяСумма = Макс(Показатели.Р03С190.Значение - Показатели.Р03С118.Значение, 0);
	Настройки.ЭтоОшибка = НЕ Показатели.Р03С210.Значение = РасчетнаяСумма;
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
		Показатели.Р03С210.Значение, Показатели.Р03С190.Значение, Показатели.Р03С118.Значение, РасчетнаяСумма);
...
Процедура ПроверкаКС_1_11(СтруктураРезультата)
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р03С010", "П000300001005");
	ИменаПоказателей.Вставить("Р03С020", "П000300002005");
	ИменаПоказателей.Вставить("Р03С030", "П000300003005");
	ИменаПоказателей.Вставить("Р03С040", "П000300004005");
	ИменаПоказателей.Вставить("Р03С041", "П000300004105");
	ИменаПоказателей.Вставить("Р03С042", "П000300004205");
	...
	РасчетнаяСумма = Показатели.Р03С010.Значение + Показатели.Р03С020.Значение + Показатели.Р03С030.Значение + 
		Показатели.Р03С040.Значение + Показатели.Р03С041.Значение + Показатели.Р03С042.Значение;
	Настройки.ЭтоОшибка = НЕ РасчетнаяСумма >= Показатели.Р03С170.Значение;
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
		Показатели.Р03С010.Значение, Показатели.Р03С020.Значение, Показатели.Р03С030.Значение, Показатели.Р03С040.Значение,
		Показатели.Р03С041.Значение, Показатели.Р03С042.Значение, РасчетнаяСумма, Показатели.Р03С170.Значение);
...
Процедура ПроверкаКС_1_12(СтруктураРезультата)
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р03С060", "П000300006005");
	...
	Настройки.ЭтоОшибка = НЕ Показатели.Р03С060.Значение >= Показатели.Р03С140.Значение;
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
		Показатели.Р03С060.Значение, Показатели.Р03С140.Значение);
...
Процедура ПроверкаКС_1_13(СтруктураРезультата)
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р32С001Г02"	, "П000320000102_");
	ИменаПоказателей.Вставить("Р03С118"		, "П000300011805");
	...
	Настройки.ЭтоОшибка = НЕ Показатели.Р32С001Г02.Итог <= Показатели.Р03С118.Значение;
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
		Показатели.Р32С001Г02.Итог, Показатели.Р03С118.Значение);
...
Процедура ПроверкаКС_1_14(СтруктураРезультата)
	...
	ИменаПоказателей = Новый Структура;
	ИменаПоказателей.Вставить("Р32С001Г03"	, "П000320000103_");
	ИменаПоказателей.Вставить("Р03С190"		, "П000300019003");
	...
	Настройки.ЭтоОшибка = НЕ Показатели.Р32С001Г03.Итог <= Показатели.Р03С190.Значение;
	Настройки.Расшифровка = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(Настройки.ШаблонРасшифровки,
		Показатели.Р32С001Г03.Итог, Показатели.Р03С190.Значение);
...
Процедура ПроверкаКС_1_27(СтруктураРезультата)
	...
	ИменаПоказателейРазделов.Вставить("Р03С118"	, "П000300011805");
	...
	РасчетнаяСуммаРазделов = ПоказателиРазделов.Р03С118.Итог + ПоказателиРазделов.Р02С060.Итог + 
	...
	РасшифровкаРазделов = СтроковыеФункцииКлиентСервер.ПодставитьПараметрыВСтроку(ШаблонРасшифровкиРазделов,
		ПоказателиРазделов.Р03С118.Итог, ПоказателиРазделов.Р02С060.Итог, ПоказателиРазделов.Р04С050.Итог, 
...
#Область ФормированиеДанныхПоставляемыхРазделов
	...
	ДанныеР08.Вставить("Р08С180К20", 
		ИтогПоКодуОперации(ТаблицаР08, СоответствиеИмен.Получить("Р08С180"), "КодВидОпер", "20"));
	ДанныеР08.Вставить("Р08С180К19", 
		ИтогПоКодуОперации(ТаблицаР08, СоответствиеИмен.Получить("Р08С180"), "КодВидОпер", "19"));
	ДанныеР08.Вставить("Р08С180К06", 
		ИтогПоКодуОперации(ТаблицаР08, СоответствиеИмен.Получить("Р08С180"), "КодВидОпер", "06"));
	ДанныеР81.Вставить("Р81С180К20", 
		ИтогПоКодуОперации(ТаблицаР81, СоответствиеИмен.Получить("Р81С180"), "КодВидОпер", "20"));
	ДанныеР81.Вставить("Р81С180К19", 
		ИтогПоКодуОперации(ТаблицаР81, СоответствиеИмен.Получить("Р81С180"), "КодВидОпер", "19"));
	ДанныеР81.Вставить("Р81С180К06", 
		ИтогПоКодуОперации(ТаблицаР81, СоответствиеИмен.Получить("Р81С180"), "КодВидОпер", "06"));
	ДанныеР09.Вставить("Р09С200К06", 
		ИтогПоКодуОперации(ТаблицаР09, СоответствиеИмен.Получить("Р09С200"), "КодВидОпер", "06"));
	ДанныеР09.Вставить("Р09С210К06", 
		ИтогПоКодуОперации(ТаблицаР09, СоответствиеИмен.Получить("Р09С210"), "КодВидОпер", "06"));
	ДанныеР91.Вставить("Р91С280К06", 
		ИтогПоКодуОперации(ТаблицаР91, СоответствиеИмен.Получить("Р91С280"), "КодВидОпер", "06"));
	ДанныеР91.Вставить("Р91С290К06", 
		ИтогПоКодуОперации(ТаблицаР91, СоответствиеИмен.Получить("Р91С290"), "КодВидОпер", "06"));
...
Процедура СформироватьПоказатели(Показатели, ИменаПоказателей)
	...
	Для каждого Элемент Из ИменаПоказателей Цикл
		...
		Если ПодстрокаДополнения = "Г" Тогда
			МассивПредставления.Добавить("Графа " + Сред(Элемент.Ключ, 9, 2));
		КонецЕсли;
...
Процедура РасшифроватьПоказатель(Показатель)
	...
	НоваяСтрока.СсылкаНаДокументРО		= ?(Лев(Показатель.Значение.ИмяПоказателя, 7) = Лев(Показатель.Значение.Синоним, 7), 
...
Процедура ЗаполнитьИРасшифроватьПоказатели(Показатели, Источник)
	...
	Для каждого Элемент Из Показатели Цикл
		...
		Для НомерСтроки = 1 По КоличествоСтрок Цикл
			...
			Если Источник.Свойство(Элемент.Значение.ИмяПоказателя, ЗначениеВИсточнике) Тогда
				Элемент.Значение.Страница = Источник.Страница;
				
				Если ТипЗнч(ЗначениеВИсточнике) = Тип("Число") И Элемент.Значение.Округление Тогда
					Элемент.Значение.Значение = РегламентированнаяОтчетностьКлиентСервер.ОкруглитьЧислоПоФормату(ЭтаФорма, 
						ЗначениеВИсточнике);
					Элемент.Значение.Итог = Элемент.Значение.Итог + Элемент.Значение.Значение;
				ИначеЕсли ТипЗнч(ЗначениеВИсточнике) = Тип("Число") Тогда
					Элемент.Значение.Значение = ЗначениеВИсточнике;
					Элемент.Значение.Итог = Элемент.Значение.Итог + ЗначениеВИсточнике;
				Иначе
					Элемент.Значение.Значение = ЗначениеВИсточнике;
					Элемент.Значение.Итог = Элемент.Значение.Итог + 0;
				КонецЕсли;
				
				Если Элемент.Значение.Расшифровывать Тогда
					РасшифроватьПоказатель(Элемент);
					// исключение двойной расшифровки сводных показателей в разделе 5 (стр.080 и 090)
					Если Элемент.Значение.Многостраничный И НЕ Элемент.Значение.Многострочный Тогда
						Элемент.Значение.Расшифровывать = Ложь;
					КонецЕсли;
				КонецЕсли;
			КонецЕсли;
		КонецЦикла;
...
&НаСервере
Функция ИтогПоКодуОперации(ТаблицаДанных, 
							СуммируемаяКолонка, 
	...
	Если ТаблицаДанных.Колонки.Найти(СуммируемаяКолонка) = Неопределено Тогда
		Возврат Результат;
	КонецЕсли;
	
	Если КолонкаПоиска = Неопределено ИЛИ ЗначениеПоиска = Неопределено Тогда
		ВременнаяТаблица = ТаблицаДанных.Скопировать();
	Иначе
		МассивНайденныхСтрок = Новый Массив;
		
		Для Каждого СтрокаПоказателей Из ТаблицаДанных Цикл
			Если ТипЗнч(СтрокаПоказателей[КолонкаПоиска]) = Тип("Массив") 
				И НЕ СтрокаПоказателей[КолонкаПоиска].Найти(ЗначениеПоиска) = Неопределено Тогда
				МассивНайденныхСтрок.Добавить(СтрокаПоказателей);
			КонецЕсли;
		КонецЦикла;
		
		Если МассивНайденныхСтрок.Количество() > 0 Тогда
			ВременнаяТаблица = ТаблицаДанных.Скопировать(МассивНайденныхСтрок);
		Иначе
			Возврат Результат;
		КонецЕсли;
	...
	Возврат ВременнаяТаблица.Итог(СуммируемаяКолонка);
