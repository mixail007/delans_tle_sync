...
Функция СформироватьНовоеУведомление_2017_1(Данные) Экспорт 
	Попытка
		...
		Пока ПараметрыИнициализацииФормы.ДанныеМногостраничныхРазделов["Форма2017_1_ЛистБ"].Количество() < Данные.ЛистыБ.Количество() Цикл 
			ПараметрыИнициализацииФормы.ДанныеМногостраничныхРазделов["Форма2017_1_ЛистБ"].Добавить(ОбщегоНазначенияКлиентСервер.СкопироватьСтруктуру(ПараметрыИнициализацииФормы.ДанныеМногостраничныхРазделов["Форма2017_1_ЛистА"][0].Значение));
		КонецЦикла;
		...
		Пока ПараметрыИнициализацииФормы.ДанныеМногостраничныхРазделов["Форма2017_1_ЛистВ"].Количество() < Данные.ЛистыВ.Количество() Цикл 
			ПараметрыИнициализацииФормы.ДанныеМногостраничныхРазделов["Форма2017_1_ЛистВ"].Добавить(ОбщегоНазначенияКлиентСервер.СкопироватьСтруктуру(ПараметрыИнициализацииФормы.ДанныеМногостраничныхРазделов["Форма2017_1_ЛистА"][0].Значение));
		КонецЦикла;
