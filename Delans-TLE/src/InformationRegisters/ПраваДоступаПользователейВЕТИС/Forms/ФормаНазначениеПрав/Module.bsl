...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.СозданиеНового Тогда
		...
		ИначеЕсли НЕ ИспользуетсяКомиссияИлиПереработка() Тогда
...
Функция ИспользуетсяКомиссияИлиПереработка()
	
	Возврат ИнтеграцияВЕТИСПереопределяемый.ИспользуетсяКомиссияИлиПереработка();
