...
Функция ПроверяемыеРеквизитыОбсуждения() Экспорт
	...
	|СтруктурнаяЕдиницаРезерв,
	|СуммаДокумента,
	//ЭР Несторук С.И. 07.10.2017 22:17:03 {
	|ES_НППлан,
	|ES_ЧекНаОбщуюСумму,
	|ES_Предоплачен,
	|ES_ТребуетсяПрозвон,
	...
	|ES_АдресДоставки,
	|ES_ДатаДоставки,
	|ES_СрочностьДоставки,
	|ES_Получатель,
	|ES_ПолучательКонтактноеЛицо,
	|ES_ПолучательТелефон,
	|ES_Объем,
	|ES_ОбщийВес,
	|ES_ОбщийОбъемныйВес,
	|Высота,
	|Длина,
	|Ширина,
	|ES_ОтмененЗаказчиком,
	|ES_Терминал,
	|ES_Направление,
	|ES_Город1,
	|ES_АдресДоставкиГород,
	|ES_ОбьявленнаяСтоимость";
	//}ЭР Несторук С.И.
