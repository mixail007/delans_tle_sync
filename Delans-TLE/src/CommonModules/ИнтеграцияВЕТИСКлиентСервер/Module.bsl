...
//																									части объекта.
//		* Суффикс									- Строка									- Суффик реквизита 'Количество' табличной части объекта.
...
//      в порядке подставления в шаблон (разделитель - ",");
...
Функция ДеревоОтбораОрганизацииВЕТИСВМассивСтруктур(ДеревоХозяйствующихСубъектовПредпритийВЕТИС, ВсеСтроки = Истина, ФормироватьХэш = Истина, ВсеПредприятияВыбраны = Истина) Экспорт 
	...
	ЭлементыДерева = ДеревоХозяйствующихСубъектовПредпритийВЕТИС.ПолучитьЭлементы();
