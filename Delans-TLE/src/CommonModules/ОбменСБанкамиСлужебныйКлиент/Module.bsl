...
Процедура РасшифроватьМаркерБанка(Результат, ДополнительныеПараметры) Экспорт
	...
	Если НЕ ДополнительныеПараметры.Свойство("ВозврСоответствие") Тогда
		ДополнительныеПараметры.Вставить("ВозврСоответствие", Новый Соответствие);
	КонецЕсли;
	
	ВозврСоответствие = ДополнительныеПараметры.ВозврСоответствие;
