...
Функция ПолучитьЛидыПоАдресамЭП(АдресаЭП, Результат)
	...
	|
	|ВЫБРАТЬ
	|	ВЫРАЗИТЬ(ЛидыКонтакты.Наименование КАК СТРОКА(1000)),
	...
	|		ПО ЛидыКонтакты.Ссылка = ЛидыКонтактнаяИнформация.Ссылка
	|			И ЛидыКонтакты.ИдентификаторСтрокиТабличнойЧасти = ЛидыКонтактнаяИнформация.ИдентификаторСтрокиТабличнойЧасти
	|ГДЕ
	|	ЛидыКонтактнаяИнформация.АдресЭП В(&АдресаЭП)");
