...
//
// Параметры:
//  ЗначениеПоиска - Число, СправочникСсылка.ПродукцияВЕТИС, Булево - значение для перекодировки
// 
// Возвращаемое значение:
//  Число, СправочникСсылка.ПродукцияВЕТИС, Соответствие - значение после перекодировки
//   (особый случай: ТипПродукции(Истина) возвращает все типы продукции ВетИС)
//
Функция ТипПродукции(ЗначениеПоиска) Экспорт
	...
	ИначеЕсли ЗначениеПоиска = ПредопределенноеЗначение("Справочник.ПродукцияВЕТИС.МясоИМясопродукты") Тогда
		Возврат 1;
	...
	ИначеЕсли ЗначениеПоиска = Истина Тогда
		Результат = Новый Соответствие;
		Результат.Вставить(1, ПредопределенноеЗначение("Справочник.ПродукцияВЕТИС.МясоИМясопродукты"));
		Результат.Вставить(2, ПредопределенноеЗначение("Справочник.ПродукцияВЕТИС.КормаИКормовыеДобавки"));
		Результат.Вставить(3, ПредопределенноеЗначение("Справочник.ПродукцияВЕТИС.ЖивыеЖивотные"));
		Результат.Вставить(4, ПредопределенноеЗначение("Справочник.ПродукцияВЕТИС.ЛекарственныеСредства"));
		Результат.Вставить(5, ПредопределенноеЗначение("Справочник.ПродукцияВЕТИС.ПищевыеПродукты"));
		Результат.Вставить(6, ПредопределенноеЗначение("Справочник.ПродукцияВЕТИС.НепищевыеПродуктыИДругое"));
		Результат.Вставить(7, ПредопределенноеЗначение("Справочник.ПродукцияВЕТИС.РыбаИМорепродукты"));
		Результат.Вставить(8, ПредопределенноеЗначение("Справочник.ПродукцияВЕТИС.ПродукцияНеТребующаяРазрешения"));
		Возврат Результат;
	КонецЕсли;
...
Функция ТипМаркировкиУпаковки(ЗначениеПоиска) Экспорт
	...
	Если ЗначениеПоиска = Перечисления.ТипыМаркировкиУпаковокВЕТИС.Произвольная Тогда
		Возврат "UNDEFINED";
...
Функция ТипПроисхожденияНепищевойПродукции(ЗначениеПоиска) Экспорт
	...
	ИначеЕсли ЗначениеПоиска = "CATTLE_SLAUGHTER" Тогда
