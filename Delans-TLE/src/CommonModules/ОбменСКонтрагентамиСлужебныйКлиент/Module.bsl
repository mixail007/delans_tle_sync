...
Процедура ПодписатьЭД(РезультатВыполнения, Параметры) Экспорт
	...
	Иначе
		...
		Если РезультатВыполнения.Свойство("КонтекстОперации") Тогда
			Параметры.Вставить("КонтекстОперацииПодписания", РезультатВыполнения.КонтекстОперации);
		КонецЕсли;
...
Процедура ОтправкаЭД(Параметры)
	...
	Если Результат.Свойство("СтруктураКОтправке", СтруктураКОтправке) Тогда
		...
		Если РасшифроватьМаркер Тогда
			...
			Если Параметры.Свойство("КонтекстОперацииПодписания") Тогда
				ДопПараметры.Вставить("КонтекстОперацииПодписания", Параметры.КонтекстОперацииПодписания);
			КонецЕсли;
		...
		Если ДополнительныеПараметры.Свойство("СоответствиеСоглашенийИСертификатов", СоответствиеСоглашенийИСертификатов)
			...
			Для Каждого Элемент Из СоответствиеСоглашенийИСертификатов Цикл
				...
				Если МассивСертификатов.Количество() > 0 Тогда
					...
					Если ДополнительныеПараметры.Свойство("КонтекстОперацииПодписания") Тогда
						ОписаниеДанных.Вставить("КонтекстОперации", ДополнительныеПараметры.КонтекстОперацииПодписания);
					КонецЕсли;
