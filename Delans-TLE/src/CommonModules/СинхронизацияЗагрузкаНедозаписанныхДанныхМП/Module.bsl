...
Процедура НайтиНедозаписанныеДанные() Экспорт
...
Функция ПоискОдинаковогоНомераУСправочникаИлиДокументаДляЦентральногоУзла(ОбъектXDTOКонфигурации, КодУзла, ОбъектМетаданных) Экспорт
	...
	ИначеЕсли Метаданные.Справочники.Содержит(ОбъектМетаданных) И ТипЗнч(ОбъектXDTOКонфигурации.Ref) <> Тип("СправочникСсылка.СтавкиНДС") И ТипЗнч(ОбъектXDTOКонфигурации.Ref) <> Тип("СправочникСсылка.КассыККММП") Тогда
