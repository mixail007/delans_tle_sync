...
Процедура УстановитьОтборСписка(Форма, СписокОтбора, ИмяПоляОтбора, ИмяСписка = "", ИспользованиеОтбора=Неопределено, ИмяТЧДанныеМеток = "ДанныеМеток") Экспорт
	...
	УправлениеНебольшойФирмойКлиентСервер.УстановитьЭлементОтбораСписка(СписокОтбора, ИмяПоляОтбора, МассивОтбора, ИспользованиеОтбора, ТекВидСравнения);
...
//
Процедура НастроитьПанельОтборовМобильныйКлиент(Форма, ИмяЭлементаПраваяПанель = "ПраваяПанель", ИмяТЧДанныеМеток = "ДанныеМеток", РеквизитыОтбораПравойПанели = "", НеотображаемыеЭлементы = "СвернутьОтборы,ДекорацияРазвернутьОтборы") Экспорт
...
Процедура ВосстановитьНастройкиОтборов(Форма, СписокОтбора, ИмяСписка = "", 
	...
	// Мобильный клиент
	Если ОбщегоНазначения.ЭтоМобильныйКлиент() Тогда
		НастроитьПанельОтборовМобильныйКлиент(Форма);
	Иначе
