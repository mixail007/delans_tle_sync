...
Процедура ПроверитьСериюРассчитатьСтатус(Объект, ТекущаяСтрока) Экспорт
	...
	СерииИспользуются = ГосударственныеИнформационныеСистемыПереопределяемый.ПризнакИспользованияСерий(ТекущаяСтрока.Номенклатура);
...
#Область СлужебныеРеквизитыНоменклатуры
