...
Функция ПодготовкаДанныхДляПробитияЧекаККМ(ДокументОбъект, ДанныеЕГАИСДостаточны, ЕстьАлкогольнаяПродукцияЕГАИС) Экспорт
	...
	//ЭР Несторук С.И. 15.11.2018 9:43:11 {
	|	,
	|	ТаблицаДокумента.ES_НомерНакладной,
	|	ТаблицаДокумента.ES_ЭтоГруз,
	|	ТаблицаДокумента.ES_Содержание
	//}ЭР Несторук С.И.
	...
	//ЭР Несторук С.И. 15.11.2018 9:43:11 {
	|	,
	|	ТаблицаТовары.ES_НомерНакладной,
	|	ТаблицаТовары.ES_ЭтоГруз,
	|	ТаблицаТовары.ES_Содержание
	//}ЭР Несторук С.И.
