...
// 
// Параметры:
//   Форма - УправляемаяФорма - Форма списка, для которой необходимо сформировать список команд
...
//   ИмяСписка - Строка - Наименование списка, из формы которого вызывается процедура. Если значение не заполнено, подразумевается Наименование "Список"
//
...
// 
// Параметры:
//   Форма - УправляемаяФорма - Форма денежного документа
//
Процедура ОбработатьВидОперации(Форма) Экспорт
	...
	Если ВидОперацииСтрокой(Объект.ВидОперации) = "ЛичныеСредстваПредпринимателя" Тогда
...
// Параметры:
//   ЮридическоеФизическоеЛицо - ПеречислениеСсылка.ЮридическоеФизическоеЛицо - Если параметр заполнен, возвращается список организаций только определенного вида
//
...
//   Представление - Строка - Представление вида операции в пользовательском режиме, если не заполнено, используется стандартное строковое представление
