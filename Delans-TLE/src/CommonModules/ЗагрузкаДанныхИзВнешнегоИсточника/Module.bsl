...
Процедура ПриСозданииНаСервере(ОбъектЗаполнения, НастройкиЗагрузкиДанных, ЭтотОбъект, ИспользоватьФормуБСП = Истина) Экспорт
	...
	НастройкиЗагрузкиДанных.Вставить("ИспользоватьСовместно", ЗагрузкаДанныхИзВнешнегоИсточника.ИспользоватьСовместноСПоставляемойЧастьюБСП() И ИспользоватьФормуБСП И НЕ ОбщегоНазначенияКлиентСервер.ЭтоВебКлиент() И НЕ УправлениеНебольшойФирмойСервер.ЭтоМобильныйКлиент());
