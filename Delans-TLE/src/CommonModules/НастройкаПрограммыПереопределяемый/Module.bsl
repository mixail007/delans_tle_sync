...
Процедура РазделыНастроек(ДеревоРазделов, знач РежимРаботы) Экспорт
	...
	Раздел_Программы1СПредприятие.Представление = НСтр("ru='Синхронизация с программами 1С:Предприятие и РИБ'");
	...
	Раздел_БизнесСеть = Раздел_ОбменЭлектроннымиДокументами.Строки.Добавить();
	Раздел_БизнесСеть.Идентификатор = "БизнесСеть";
	Раздел_БизнесСеть.Представление = НСтр("ru='1C:Бизнес-сеть'");
	
	Раздел_1СНоменклатура = Раздел_ОбменЭлектроннымиДокументами.Строки.Добавить();
	Раздел_1СНоменклатура.Идентификатор = "1СНоменклатура";
	Раздел_1СНоменклатура.Представление = НСтр("ru='1С:Номенклатура'");
	...
	Раздел_ИнтеграцияСЯндексКассой = Раздел_ОбменЭлектроннымиДокументами.Строки.Добавить();
	Раздел_ИнтеграцияСЯндексКассой.Идентификатор = "ИнтеграцияСЯндексКассой";
	Раздел_ИнтеграцияСЯндексКассой.Представление = НСтр("ru='Яндекс.Касса'");
...
Процедура НастройкиПрограммы(ТаблицаНастроек, знач РежимРаботы) Экспорт
	...
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.ВместеС = "ИспользоватьНесколькоОрганизаций";
	НоваяНастройка.Зависимости = "УчетПоКомпании,ИспользоватьНесколькоОрганизаций";
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		...
		"Компания",
		НСтр("ru='Регламентированная отчетность (только для ИП)'"),
		НСтр("ru='Включение позволяет формировать регламентированную отчетность и сдавать в контролирующие органы.
		|
		|Можно сдавать отчетность, если ИП использует упрощенную систему налогообложения (УСН), единый налог на вмененный доход (ЕНВД) и/или патент.'")
	);
	НоваяНастройка.ОбновлятьИнтерфейс = Истина;
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		...
		"Компания",
		НСтр("ru='Учет подконтрольной продукции ВЕТИС'"),
		НСтр("ru='Включение позволяет обмениваться данными с системой ""Меркурий"".'")
	);
	НоваяНастройка.ОбновлятьИнтерфейс = Истина;
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	...
	НоваяНастройка.Зависимости = "ВестиСведенияДляДекларацийПоАлкогольнойПродукции,ФункциональнаяОпцияУчетРозничныхПродаж";
	НоваяНастройка.Теги = НСтр("ru='Расходная накладная,Номенклатура,Категории номенклатуры,Виды алкогольной продукции,Лицензии поставщиков алкогольной продукции'");
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		"ВестиУчетМаркировкиТабачнойПродукции",
		"Компания",
		НСтр("ru='Вести учет маркировки табачной продукции'"),
		НСтр("ru='Передача в ККТ сведений о розничной реализации маркируемой табачной продукции в соответствии с постановлением Правительства Российской Федерации от 27 ноября 2017 г. № 1433 «О проведении эксперимента по маркировке табачной продукции средствами идентификации и мониторингу оборота табачной продукции»'")
	);
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		...
		"CRM",
		НСтр("ru='Использовать телефонию'"),
		НСтр("ru='Благодаря интеграции 1С:УНФ с телефонией:
		|•	При входящем звонке автоматически откроется карточка клиента
	...
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.Теги = НСтр("ru='АТС,Интеграция с др. приложениями,Телефония'");
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуКоманда(ТаблицаНастроек,
		...
		"CRM",
		НСтр("ru='Выбор оператора и настройка интеграции'"),
		НСтр("ru=''")
	);
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.ВместеС = "ИспользоватьТелефонию";
	НоваяНастройка.Теги = НСтр("ru='Телефония,АТС,Интеграция с др. приложениями'");
	...
	НоваяНастройка.Теги = НСтр("ru='Заказ покупателя,CRM,Коммерческие предложения'");
	
	НоваяНастройка = ТаблицаНастроек.Добавить();
	НоваяНастройка.Идентификатор	= "ДоговорыКонтрагентов";
	НоваяНастройка.Раздел			= "CRM";
	НоваяНастройка.Представление	= НСтр("ru='Контроль договоров контрагентов'");
	НоваяНастройка.ТипЭлемента		= Тип("ДекорацияФормы");
	НоваяНастройка.СвойстваЭлемента	= Новый Структура;
	НоваяНастройка.СвойстваЭлемента.Вставить("Заголовок", НоваяНастройка.Представление);
	НоваяНастройка.ДобавлятьОтступ = Истина;
	...
	НоваяНастройка.СвойстваЭлемента.Вставить("ОтображениеПодсказки", ОтображениеПодсказки.Кнопка);
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.Теги = НСтр("ru='Договоры,CRM'");
	
	НоваяНастройка = ТаблицаНастроек.Добавить();
	НоваяНастройка.Идентификатор	= "КонтрольДоговоровКонтрагентов";
	НоваяНастройка.Раздел			= "CRM";
	...
	НоваяНастройка.Описание			= НСтр("ru='При проведении документов, у которых договор контрагента не соответствует операции документа:
		...
		|• Не контролировать. Документ проводится, сообщения не выдаются.
		|
		|Для того, чтобы договор соответствовал операции документа необходимо, чтобы в договоре была указана верная организация и соответсвующий вид договора. 
		|
		|ВАЖНО!
		|При настроенной синхронизации данных с программой ""1С: Бухгалтерия предприятия"" контроль по договорам обязателен!'");
	...
	НоваяНастройка.СвойстваЭлемента.СписокВыбора.Добавить(3, НСтр("ru='Не проводить'"));
	НоваяНастройка.СвойстваЭлемента.СписокВыбора.Добавить(2, НСтр("ru='Предупреждать'"));
	НоваяНастройка.СвойстваЭлемента.СписокВыбора.Добавить(1, НСтр("ru='Не контролировать'"));
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.ВместеС = "ДоговорыКонтрагентов";
	НоваяНастройка.Теги = НСтр("ru='CRM,Договоры'");
	
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуГиперссылкаНавигации(ТаблицаНастроек,
		"НастройкиНумерацииДоговоров",
		"CRM",
		НСтр("ru='Настройки нумерации договоров'"),
		НСтр("ru='Настройка автоматической нумерации документов контрагентов'"),
		"e1cib/list/Справочник.НастройкиНумерацииДоговоровКонтрагентов"
	);
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.ВместеС = "ДоговорыКонтрагентов";
	НоваяНастройка.Теги = НСтр("ru='CRM,Договоры,Настройка программы'");
	
	НоваяНастройка = ТаблицаНастроек.Добавить();
	НоваяНастройка.Идентификатор	= "ОбсужденияИВзаимодействия";
	НоваяНастройка.Раздел			= "CRM";
	НоваяНастройка.Представление	= НСтр("ru='Обсуждения'");
	НоваяНастройка.ТипЭлемента		= Тип("ДекорацияФормы");
	НоваяНастройка.СвойстваЭлемента	= Новый Структура;
	НоваяНастройка.СвойстваЭлемента.Вставить("Заголовок", НоваяНастройка.Представление);
	НоваяНастройка.ДобавлятьОтступ = Истина;
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		...
		"CRM",
		НСтр("ru='Чат, история изменений и видеозвонки (новый интерфейс)'"),
		НСтр("ru='Включить ""Обсуждения"": пользователи могут общаться друг с другом в режиме реального времени с помощью текстовых сообщений и видеозвонков* в 1С.
		|Можно вести чат в контексте объектов, создать независимый чат с выбранными участниками, подписаться на обновления в выбранном чате.
		|
		|Для работы взаимодействий требуется подключение к интернету и регистрация по e-mail в сервисе 1С:Диалог (один раз для базы данных).
		|(*) Возможность совершать видеозвонки находится на этапе тестирования. Чтобы принять участие в тестировании, отправьте письмо на info@1cDialog.com'")
	);
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.ВместеС = "ОбсужденияИВзаимодействия";
	НоваяНастройка.Теги = НСтр("ru='CRM,Чат'");
	
	Если УправлениеНебольшойФирмойПовтИсп.ДоступнаНастройкаЧатВОбсуждениях() Тогда
		НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
			"ИспользоватьЧатВОбсуждениях",
			"CRM",
			НСтр("ru='Чат, история изменений (устарело)'"),
			НСтр("ru='В панели навигации ""Обсуждения"" переименованы в ""История"" и могут использоваться как с чатом, так и без.
		|
		|Для чата в ""Истории"" объектов подключение к интернету не требуется.
		|
		|Чтобы использовать чат в ""Истории"" объектов, установите флажок.'")
		);
		НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
		НоваяНастройка.ВместеС = "ОбсужденияИВзаимодействия";
		НоваяНастройка.Теги = НСтр("ru='CRM,Чат'");
	...
	НоваяНастройка = ТаблицаНастроек.Добавить();
	НоваяНастройка.Идентификатор	= "ИсточникиПривлечения";
	НоваяНастройка.Раздел			= "CRM";
	НоваяНастройка.Представление	= НСтр("ru='Источник привлечения'");
	НоваяНастройка.ТипЭлемента		= Тип("ДекорацияФормы");
	НоваяНастройка.СвойстваЭлемента	= Новый Структура;
	НоваяНастройка.СвойстваЭлемента.Вставить("Заголовок", НоваяНастройка.Представление);
	НоваяНастройка.ДобавлятьОтступ = Истина;
	...
	НоваяНастройка.СвойстваЭлемента.Вставить("ОтображениеПодсказки", ОтображениеПодсказки.Кнопка);
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.Теги = НСтр("ru='Источник привлечения'");
	
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуКоманда(ТаблицаНастроек,
		"ВыборОбъектовДляОбязательногоЗаполненияИсточника",
		"CRM",
		НСтр("ru='Настройка обязательности заполнения'"),
		НСтр("ru=''")
	);
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.ВместеС = "ИсточникиПривлечения";
	НоваяНастройка.Теги = НСтр("ru='Источник привлечения'");
	
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		"НавыкиАссистентаУправленияНашейФирмой",
		"CRM",
		НСтр("ru='Больше навыков Ассистента УНФ (уточните какие)'"),
		НСтр("ru=''")
	);
	НоваяНастройка.ПравоРедактирования = Истина;
	НоваяНастройка.Потенциальная = Истина;
	НоваяНастройка.РасширеннаяПодсказка = Новый ФорматированнаяСтрока(
"В 1С:Управлении нашей фирмой появился ", 
Новый ФорматированнаяСтрока("ассистент управления фирмой – Даша.",,,, "e1cib/command/Обработка.АссистентУправления.Команда.ОткрытьЗадачиАссистентаУправления"), 
"
|Даша, как и обычный сотрудник, выполняет поручения в 1С:УНФ.
|Например, можно поручить Даше обработку заказов при получении оплаты или отгрузке – она изменит состояние заказа, напишет об этом в чате документа и сообщит об изменениях менеджеру.
|
|Какие еще задачи можно делегировать Даше?");
	НоваяНастройка.Теги = НСтр("ru='CRM'");
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		"ТелефонияИнтеграцияАТС",
		"CRM",
		НСтр("ru='Развитие интеграций с виртуальными АТС (уточните с какими)'"),
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		"СайтИнтеграцияCMS",
		"CRM",
		НСтр("ru='Развитие интеграций с CMS сайта (уточните с какими)'"),
		НСтр("ru='Интеграция с CMS - развитие существующих или разработка новых интеграций с системами управления контентом сайта (Битрикс, UMI или другими, укажите, какая интеграция интересна)'")
	);
	НоваяНастройка.ПравоРедактирования = Истина;
	НоваяНастройка.Потенциальная = Истина;
	НоваяНастройка.Теги = НСтр("ru='Событие,Контактные лица'");
	...
	НоваяНастройка = ТаблицаНастроек.Добавить();
	НоваяНастройка.Идентификатор	= "ПланировщикРесурсов";
	НоваяНастройка.Раздел			= "CRM";
	НоваяНастройка.Представление	= НСтр("ru='Планировщик'");
	НоваяНастройка.ТипЭлемента		= Тип("ДекорацияФормы");
	НоваяНастройка.СвойстваЭлемента	= Новый Структура;
	НоваяНастройка.СвойстваЭлемента.Вставить("Заголовок", НоваяНастройка.Представление);
	НоваяНастройка.ДобавлятьОтступ = Истина;
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		...
		"CRM",
		НСтр("ru='Журнал записи'"),
		НСтр("ru='Включение позволяет создавать плановые записи загрузки(посещений) для ресурсов
		|
		...
		|
		|Список ресурсов доступен в разделе CRM - Планирование'")
	);
	НоваяНастройка.ОбновлятьИнтерфейс = Истина;
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.ВместеС = "НастройкиНумерацииДоговоров";
	НоваяНастройка.Теги = НСтр("ru='Событие'");
	
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		"ВыгрузкаСоцсети",
		"CRM",
		НСтр("ru='Выгрузка товаров на страницы в соц.сети: Instagram, ВКонтакте, Facebook (уточните в какую)'"),
		НСтр("ru='Автоматическая выгрузка товаров из 1С на страницы в соц.сети
		|- Instagram
		|- ВКонтакте
		|- Facebook
		|уточните в какую соцсеть'")
	);
	НоваяНастройка.ПравоРедактирования = Истина;
	НоваяНастройка.Потенциальная = Истина;
	НоваяНастройка.Теги = НСтр("ru='CRM,Лиды,Контактные лица'");
	
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		"ВыгрузкаМаркетплейс",
		"CRM",
		НСтр("ru='Выгрузка товаров в маркетплейс: Яндекс.Маркет, Беру!, Ozon (уточните какой)'"),
		НСтр("ru='Автоматическая выгрузка товаров из 1С в маркетплейс:
		|- Яндекс.Маркет
		|- Беру!
		|- Wildberries
		|- Avito
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		...
		НСтр("ru='Включение позволяет указывать процент или сумму скидки/наценки отдельно для каждой строки документа, а также вести расширенный учет применяемых в фирме скидок/наценок.
		|
		|ВАЖНО!
		|Возможность нельзя отключить после начала работы в программе.'")
	);
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуГиперссылкаНавигации(ТаблицаНастроек,
		"ФункциональнаяОпцияИспользоватьАвтоматическиеОкругления",
		"Продажи",
		НСтр("ru='Автоматическое округление'"),
		НСтр("ru='Позволяет настроить автоматическое округление сумм в документах или отдельных строках'"),
		"e1cib/command/Обработка.ВидыСкидокНаценокРучныеИАвтоматические.Команда.ОткрытьОкругления"
	);
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.ВместеС = "ФункциональнаяОпцияИспользоватьАвтоматическиеСкидкиНаценки";
	НоваяНастройка.Зависимости = "ФункциональнаяОпцияИспользоватьАвтоматическиеСкидкиНаценки";
	НоваяНастройка.Теги = НСтр("ru='Скидка,Акт выполненных работ,Заказ покупателя,Отчет о переработке,Отчет о розничных продажах,Расходная накладная,Счет на оплату,Чек ККМ,Чек ККМ на возврат,Документы по продажам,Начальные остатки расчетов,Ввод начальных остатков'");
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		...
		|
		|ВАЖНО!
		|Для использования дисконтных карт необходимо использование ручных и автоматических скидок (опции будут включены автоматически).'")
	);
	НоваяНастройка.ОбновлятьИнтерфейс = Истина;
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		...
		"Продажи",
		НСтр("ru='Бонусные программы'"),
		НСтр("ru='Включение позволяет использовать бонусные программы.
		|
		|ВАЖНО!
		|Для использования возможности, требуется использование дисконтных карт, ручных и автоматических скидок (будет включено автоматически).'")
	);
	НоваяНастройка.ОбновлятьИнтерфейс = Истина;
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.Теги = НСтр("ru='Скидка,Документы по продажам,Продажи,Отчет о розничных продажах,Чек ККМ,Чек ККМ на возврат'");
	
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		"ФункциональнаяОпцияИспользоватьПодарочныеСертификаты",
		"Продажи",
		НСтр("ru='Подарочные сертификаты'"),
		НСтр("ru='Включение позволяет вести учет подарочных сертификатов: их выпуск, продажу и погашение.
		|
		|ВАЖНО!
		|Рекомендуется включить ведение серийных номеров товаров во избежание злоупотреблений сертификатами.
		|
		|ВАЖНО!
		|При включении будет автоматически создан служебный контрагент для отражения предоплаты при реализации подарочных сертификатов.
		|
		|ВАЖНО!
		|Учет сертификатов ведется только в национальной валюте.
		|
		|ВАЖНО!
		|Возможность нельзя отключить после создания первого сертификата.'")
	);
	НоваяНастройка.ОбновлятьИнтерфейс = Истина;
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.Теги = НСтр("ru='Скидка,Документы по продажам,Заказ покупателя,Продажи,Акт выполненных работ,Отчет о розничных продажах,Чек ККМ,Чек ККМ на возврат,Расходная накладная'");
	
	НоваяНастройка = ТаблицаНастроек.Добавить();
	НоваяНастройка.Идентификатор	= "КонтрагентДляПредоплаты";
	НоваяНастройка.Раздел			= "Продажи";
	НоваяНастройка.Представление	= НСтр("ru='Служебный контрагент для подарочных сертификатов'");
	НоваяНастройка.Описание			= НСтр("ru='Контрагент для учета предоплаты при продаже подарочных сертификатов'");
	НоваяНастройка.ТипРеквизита		= Новый ОписаниеТипов("СправочникСсылка.Контрагенты");
	НоваяНастройка.ТипЭлемента		= Тип("ПолеФормы");
	НоваяНастройка.СвойстваЭлемента	= Новый Структура;
	НоваяНастройка.СвойстваЭлемента.Вставить("Заголовок", НоваяНастройка.Представление);
	НоваяНастройка.СвойстваЭлемента.Вставить("Подсказка", НоваяНастройка.Описание);
	...
	НоваяНастройка.СвойстваЭлемента.Вставить("Гиперссылка", Ложь);
	НоваяНастройка.СвойстваЭлемента.Вставить("ОтображениеПодсказки", ОтображениеПодсказки.Кнопка);
	НоваяНастройка.СвойстваЭлемента.Вставить("КнопкаОткрытия", Истина);
	НоваяНастройка.СвойстваЭлемента.Вставить("ПоложениеЗаголовка", ПоложениеЗаголовкаЭлементаФормы.Нет);
	НоваяНастройка.СвойстваЭлемента.Вставить("ПодсказкаВвода", "Служебный контрагент для подарочных сертификатов");
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.ВместеС = "ФункциональнаяОпцияИспользоватьПодарочныеСертификаты";
	НоваяНастройка.Зависимости = "ФункциональнаяОпцияИспользоватьПодарочныеСертификаты";
	НоваяНастройка.Теги = НСтр("ru='Скидка,Акт выполненных работ,Заказ покупателя,Отчет о розничных продажах,Расходная накладная,Чек ККМ,Чек ККМ на возврат,Документы по продажам,Продажи'");
	
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		"ФункциональнаяОпцияИспользоватьЧастичноеПогашениеСертификатов",
		"Продажи",
		НСтр("ru='Частичное погашение сертификатов'"),
		НСтр("ru='Включение позволяет вести учет остатков в разрезе подарочных сертификатов при неполном их погашении.
		|
		|ВАЖНО!
		|Для использования возможности, требуется ведение серийных номеров и контроль их остатков (будет включено автоматически).'")
	);
	НоваяНастройка.ОбновлятьИнтерфейс = Истина;
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.ВместеС = "ФункциональнаяОпцияИспользоватьПодарочныеСертификаты";
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		...
		НСтр("ru='Включает возможность использования наборов и комплектов при продаже. Сформировать набор можно в карточке номенклатуры с типами запас или работа. В дальнейшем, при использовании этой номенклатуры в документах продажи, будет выполняться автоматическая замена составом набора.
		|
		|Пример набора: Компьютер. Состав: корпус, блок питания, материнская плата, память, жесткий диск, процессор, кулер. При продаже будут списаны комплектующие, но в печатной форме их можно не отображать.'")
	);
	НоваяНастройка.ОбновлятьИнтерфейс = Истина;
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	...
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.ВместеС = "ИспользоватьВидыЗаказовПокупателей";
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		...
		|
		|Опция доступна только если сброшен флаг ""Предоплата в чеках ККМ""!'")
	);
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.ВместеС = "ФункциональнаяОпцияУчетРозничныхПродаж";
	НоваяНастройка.Зависимости = "ФункциональнаяОпцияУчетРозничныхПродаж,ФункциональнаяОпцияИспользоватьПредоплатуВЧекахККМ";
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		...
		"Продажи",
		НСтр("ru='Предоплата в чеках ККМ'"),
		НСтр("ru='Опция позволяет принимать и зачитывать предоплату чеками ККМ. Опция доступна только если сброшен флаг ""Архивировать чеки ККМ""!'")
	);
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.ВместеС = "ФункциональнаяОпцияУчетРозничныхПродаж";
	НоваяНастройка.Зависимости = "АрхивироватьЧекиККМПриЗакрытииКассовойСмены,ФункциональнаяОпцияУчетРозничныхПродаж";
	НоваяНастройка.Теги = НСтр("ru='Чек ККМ,Чек ККМ на возврат'");
	
	НоваяНастройка = ТаблицаНастроек.Добавить();
	НоваяНастройка.Идентификатор	= "ВариантВозвратаПоЗакрытойСмене";
	НоваяНастройка.Раздел			= "Продажи";
	НоваяНастройка.Представление	= НСтр("ru='Вариант оформления возврата по чеку ККМ из закрытой смены'");
	НоваяНастройка.Описание			= НСтр("ru='Выбор варианта оформления возврата по чеку из уже закрытой смены для РМК:
		|1. Приходной накладной + РКО
		|2. Чеком ККМ
		|3. Выбор варианта перед каждым возвратом'");
	НоваяНастройка.ТипРеквизита		= Новый ОписаниеТипов("ПеречислениеСсылка.ВариантыВозвратаПоЗакрытойСмене");
	НоваяНастройка.ТипЭлемента		= Тип("ПолеФормы");
	НоваяНастройка.СвойстваЭлемента	= Новый Структура;
	НоваяНастройка.СвойстваЭлемента.Вставить("Заголовок", НоваяНастройка.Представление);
	НоваяНастройка.СвойстваЭлемента.Вставить("Подсказка", НоваяНастройка.Описание);
	...
	НоваяНастройка.СвойстваЭлемента.Вставить("РастягиватьПоГоризонтали", Ложь);
	НоваяНастройка.СвойстваЭлемента.Вставить("ВысотаЗаголовка", 2);
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.ВместеС = "ФункциональнаяОпцияУчетРозничныхПродаж";
	НоваяНастройка.Зависимости = "ФункциональнаяОпцияУчетРозничныхПродаж";
	...
	Если Не РежимРаботы.МодельСервиса Тогда
		...
		НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторСистемы;
		НоваяНастройка.ВместеС = "ФункциональнаяОпцияУчетРозничныхПродаж";
		НоваяНастройка.Зависимости = "ФункциональнаяОпцияУчетРозничныхПродаж,АвтоматическаяОтправкаЭлектронныхЧековПоРасписанию,ОтправкаЭлектронныхЧековПослеПробитияЧека";
		НоваяНастройка.Теги = НСтр("ru='54 ФЗ'");
	КонецЕсли;
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		...
		"Закупки",
		НСтр("ru='Разрешить склады в табличных частях'"),
		НСтр("ru='Предоставляет возможность указать склад в табличной части приходной и расходной накладной.
		|Подключение выполняется в форме документа по кнопке ""Ещё"" – ""Шапка или табличная часть"".
		|
		|При выгрузке в Бухгалтерию предприятия в документах будет использоваться основной склад.
		|Склад для выгрузки можно уточнить в настройках обмена.'")
	);
	НоваяНастройка.ОбновлятьИнтерфейс = Истина;
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.ВместеС = "ФункциональнаяОпцияУчетПоНесколькимСкладам";
	НоваяНастройка.Зависимости = "ФункциональнаяОпцияУчетПоНесколькимСкладам";
	НоваяНастройка.Теги = НСтр("ru='Приходная накладная,Расходная накладная'");
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		...
		"Закупки",
		НСтр("ru='Требовать заполнение ГТД для импортного товара'"),
		НСтр("ru='Требовать заполнение ГТД для импортного товара'")
	);
	НоваяНастройка.ОбновлятьИнтерфейс = Истина;
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		...
		"Работы",
		НСтр("ru='Планировать загрузку ресурсов'"),
		НСтр("ru='Включение позволяет планировать загрузку производственных ресурсов предприятия.
		|
		|Ресурсом может являться любой производственный ресурс, загрузку которого целесообразно планировать. Например: оборудование, инвентарь, механизмы, бригады рабочих, отдельные работники.
		|
		|Список ресурсов доступен в разделе Работы - Справочники - Ресурсы.'")
	);
	НоваяНастройка.ОбновлятьИнтерфейс = Истина;
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.ВместеС = "ФункциональнаяОпцияИспользоватьПодсистемуРаботы";
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		...
		"Производство",
		НСтр("ru='Использовать производство в несколько этапов'"),
		НСтр("ru='Позволяет отразить в учете длительный процесс производства продукции. Изготовление выполняется в несколько фиксированных этапов, каждый из которых может длиться более одного дня. Опция доступна только после включения резервирования запасов (раздел настроек ""Закупки"").'")
	);
	НоваяНастройка.ОбновлятьИнтерфейс = Истина;
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.ВместеС = "ФункциональнаяОпцияИспользоватьПодсистемуПроизводство";
	НоваяНастройка.Зависимости = "ФункциональнаяОпцияИспользоватьПодсистемуПроизводство,ФункциональнаяОпцияРезервированиеЗапасов";
	НоваяНастройка.Теги = НСтр("ru='Номенклатура,Производство,Заказ на производство,Сдельный наряд,Этапы'");
	
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		"ФункциональнаяОпцияВыполнениеЭтаповРазнымиПодразделениями",
		"Производство",
		НСтр("ru='Этапы могут выполняться разными подразделениями'"),
		НСтр("ru='Для каждого из этапов производства одного изделия можно указывать разные подразделения-изготовители. В таком случае необходимо выбрать структурную единицу накопления себестоимости продукции (завершающего этапа) при вводе заказа на производство или при выполнении первого этапа. Опция доступна только при включении учета по нескольким подразделениям.'")
	);
	НоваяНастройка.ОбновлятьИнтерфейс = Истина;
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.ВместеС = "ФункциональнаяОпцияИспользоватьПодсистемуПроизводство";
	НоваяНастройка.Зависимости = "ФункциональнаяОпцияИспользоватьЭтапыПроизводства,ФункциональнаяОпцияУчетПоНесколькимПодразделениям";
	НоваяНастройка.Теги = НСтр("ru='Номенклатура,Производство,Заказ на производство,Сдельный наряд,Этапы'");
	
	НоваяНастройка = ТаблицаНастроек.Добавить();
	НоваяНастройка.Идентификатор	= "ИспользоватьРучноеРаспределениеМатериаловПоУмолчанию";
	НоваяНастройка.Раздел			= "Производство";
	НоваяНастройка.Представление	= НСтр("ru='Способ распределения материалов по умолчанию'");
	НоваяНастройка.Описание			= НСтр("ru='Способ распределения материалов по умолчанию. Расчет может выполняться двумя способами:
		|
		|• Автоматически по спецификации и количеству изделий.  
		|
		|• Вручную - пользователь сам может указать, на изготовление какого изделия потрачен конкретный материал.'");
	...
	НоваяНастройка.СвойстваЭлемента.Вставить("ОтображениеПодсказки", ОтображениеПодсказки.Кнопка);
	НоваяНастройка.СвойстваЭлемента.Вставить("СписокВыбора", Новый СписокЗначений);
	НоваяНастройка.СвойстваЭлемента.СписокВыбора.Добавить(Перечисления.ДаНет.Нет, НСтр("ru='Автоматически'"));
	НоваяНастройка.СвойстваЭлемента.СписокВыбора.Добавить(Перечисления.ДаНет.Да, НСтр("ru='Вручную'"));
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.ВместеС = "ФункциональнаяОпцияИспользоватьПодсистемуПроизводство";
	НоваяНастройка.Зависимости = "ФункциональнаяОпцияИспользоватьПодсистемуПроизводство";
	НоваяНастройка.Теги = НСтр("ru='Номенклатура,Производство,Заказ на производство'");
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		...
		|• начислять зарплату сотрудникам по сдельным нарядам (для полноценной работы нужно включить настройку ""Управление персоналом, начисление зарплаты"" в разделе ""Зарплата"");
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		...
		"Производство",
		НСтр("ru='Планировать операции заказом на производство'"),
		НСтр("ru='При включении опции в заказах на производство, созданных на основании других документов, будет автоматически заполняться таблица операций.'")
	);
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.ВместеС = "ФункциональнаяОпцияИспользоватьПодсистемуПроизводство";
	НоваяНастройка.Зависимости = "ФункциональнаяОпцияИспользоватьТехоперации";
	НоваяНастройка.Теги = НСтр("ru='Заказ на производство'");
	
	НоваяНастройка = ТаблицаНастроек.Добавить();
	НоваяНастройка.Идентификатор	= "РасчетСтоимостиОперацийПоНормеВремени";
	НоваяНастройка.Раздел			= "Производство";
	НоваяНастройка.Представление	= НСтр("ru='Способ расчета стоимости операций по умолчанию'");
	НоваяНастройка.Описание			= НСтр("ru='Способ расчета стоимости технологической операции по умолчанию. Может выполняться двумя способами:
		|
		|• Только по количеству операций (фиксированная стоимость).  
		|
		|• С учетом времени, затрачиваемого на производство (используется норма времени из спецификации изделия).
		|
		|Стоимость одной операции вычисляется по учетной цене.'");
	НоваяНастройка.ТипРеквизита		= Новый ОписаниеТипов("ПеречислениеСсылка.ДаНет");
	НоваяНастройка.ТипЭлемента		= Тип("ПолеФормы");
	НоваяНастройка.СвойстваЭлемента	= Новый Структура;
	НоваяНастройка.СвойстваЭлемента.Вставить("Заголовок", НоваяНастройка.Представление);
	...
	НоваяНастройка.СвойстваЭлемента.Вставить("КоличествоКолонок", 1);
	НоваяНастройка.СвойстваЭлемента.Вставить("СписокВыбора", Новый СписокЗначений);
	НоваяНастройка.СвойстваЭлемента.СписокВыбора.Добавить(Перечисления.ДаНет.Да, НСтр("ru='По норме времени'"));
	НоваяНастройка.СвойстваЭлемента.СписокВыбора.Добавить(Перечисления.ДаНет.Нет, НСтр("ru='Фиксированная стоимость'"));
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.ВместеС = "ФункциональнаяОпцияИспользоватьПодсистемуПроизводство";
	НоваяНастройка.Зависимости = "ФункциональнаяОпцияИспользоватьТехоперации";
	НоваяНастройка.Теги = НСтр("ru='Номенклатура,Производство,Сдельный наряд'");
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		...
		|Ресурсом может являться любой производственный ресурс, загрузку которого целесообразно планировать. Например: оборудование, инвентарь, механизмы, бригады рабочих, отдельные работники.
		|
		|Список ресурсов доступен в разделе Производство - Справочники - Ресурсы'")
	);
	НоваяНастройка.ОбновлятьИнтерфейс = Истина;
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.ВместеС = "ФункциональнаяОпцияПереработкаДавальческогоСырья";
	НоваяНастройка.Зависимости = "ФункциональнаяОпцияИспользоватьПодсистемуПроизводство";
	НоваяНастройка.Теги = НСтр("ru='Заказ на производство'");
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		...
		"Деньги",
		НСтр("ru='Резервирование денег'"),
		НСтр("ru='Включение позволяет резервировать свободные денежные средства для оплаты заявкок на расход, перемещения денег (план), счетов на оплату и заказов поставщикам, а также ввести неснижаемый остаток по счету или кассе.'")
	);
	НоваяНастройка.ОбновлятьИнтерфейс = Истина;
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.ВместеС = "ФункциональнаяОпцияПлатежныйКалендарь";
	НоваяНастройка.Зависимости = "ФункциональнаяОпцияПлатежныйКалендарь";
	НоваяНастройка.Теги = НСтр("ru='Документы планирования денег,Заявка на расход денег,Перемещение денег (план),Заказ поставщику,Счет на оплату (полученный),Документы по банку,Документы по кассе'");
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		...
		"Деньги",
		НСтр("ru='Оплата кредитом в рознице'"),
		НСтр("ru='Включение позволяет использовать оплату кредитом.
		|
		|ВАЖНО!
		|Для использования возможности, требуется использование оплаты банковскими картами (будет включено автоматически).'")
	);
	НоваяНастройка.ОбновлятьИнтерфейс = Истина;
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.Теги = НСтр("ru='Документы по продажам,Продажи,Отчет о розничных продажах,Чек ККМ,Чек ККМ на возврат'");
	...
	НоваяНастройка = ТаблицаНастроек.Добавить();
	НоваяНастройка.Идентификатор	= "ДекорацияКонтрольУказанияСчетаИЗаказа";
	НоваяНастройка.Раздел			= "Деньги";
	НоваяНастройка.Представление	= НСтр("ru='Заполнение реквизитов контрагента по умолчанию'");
	НоваяНастройка.ТипЭлемента		= Тип("ДекорацияФормы");
	НоваяНастройка.СвойстваЭлемента	= Новый Структура;
	НоваяНастройка.СвойстваЭлемента.Вставить("Заголовок", НоваяНастройка.Представление);
	НоваяНастройка.ДобавлятьОтступ = Истина;
	...
	НоваяНастройка = ТаблицаНастроек.Добавить();
	НоваяНастройка.Идентификатор	= "ДекорацияСмотретьДолги";
	НоваяНастройка.Раздел			= "Деньги";
	НоваяНастройка.Представление	= НСтр("ru='Смотреть долги'");
	НоваяНастройка.ТипЭлемента		= Тип("ДекорацияФормы");
	НоваяНастройка.СвойстваЭлемента	= Новый Структура;
	НоваяНастройка.СвойстваЭлемента.Вставить("Заголовок", НоваяНастройка.Представление);
	НоваяНастройка.СвойстваЭлемента.Вставить("Вид", ВидДекорацииФормы.Надпись);
	...
	НоваяНастройка.СвойстваЭлемента.Вставить("ОтображениеПодсказки", ОтображениеПодсказки.Кнопка);
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.ВместеС = "ДекорацияКонтрольУказанияСчетаИЗаказа";
	
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		"ВестиРасчетыПоДоговорам",
		"Деньги",
		НСтр("ru='по договорам'"),
		НСтр("ru='Значение по умолчанию для одноименного флага в карточке контрагента / договора.'")
	);
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.ВместеС = "ДекорацияКонтрольУказанияСчетаИЗаказа";
	НоваяНастройка.Теги = НСтр("ru='Контрагенты,Договоры,Поступление в кассу,Поступление на счет,Операция по платежным картам,Расход из кассы,Расход со счета,Заказ покупателя,Заказ поставщику,Акт выполненных работ,Расходная накладная,Приходная накладная,Заказ-наряд,Счет на оплату,Счет на оплату (полученный),Дополнительные расходы'");
	
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		"ВестиРасчетыПоДокументам",
		"Деньги",
		НСтр("ru='по документам'"),
		НСтр("ru='Значение по умолчанию для одноименного флага в карточке контрагента / договора.
		|
		|Доступность флага зависит от опции ""Компания - Регламентированная отчетность"". Если эта опция установлена, то текущая опция недоступна.'")
	);
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.ВместеС = "ДекорацияКонтрольУказанияСчетаИЗаказа";
	НоваяНастройка.Зависимости = "ФункциональнаяОпцияИспользоватьОтчетность";
	НоваяНастройка.Теги = НСтр("ru='Контрагенты,Договоры,Поступление в кассу,Поступление на счет,Операция по платежным картам,Расход из кассы,Расход со счета,Заказ покупателя,Заказ поставщику,Акт выполненных работ,Расходная накладная,Приходная накладная,Заказ-наряд,Счет на оплату,Счет на оплату (полученный),Дополнительные расходы'");
	...
	НоваяНастройка = ТаблицаНастроек.Добавить();
	НоваяНастройка.Идентификатор	= "ДекорацияСмотретьОплату";
	НоваяНастройка.Раздел			= "Деньги";
	НоваяНастройка.Представление	= НСтр("ru='Смотреть оплату'");
	НоваяНастройка.ТипЭлемента		= Тип("ДекорацияФормы");
	НоваяНастройка.СвойстваЭлемента	= Новый Структура;
	НоваяНастройка.СвойстваЭлемента.Вставить("Заголовок", НоваяНастройка.Представление);
	НоваяНастройка.ДобавлятьОтступ = Истина;
	...
	НоваяНастройка = ТаблицаНастроек.Добавить();
	НоваяНастройка.Идентификатор	= "СпособРазнесенияОплатыПоУмолчанию";
	НоваяНастройка.Раздел			= "Деньги";
	НоваяНастройка.Представление	= НСтр("ru='Разносить оплату'");
	НоваяНастройка.Описание			= НСтр("ru='Для установки значения на закладке ""Предоплата"" в расходной накладной, акте выполненных работ и др. документах.
		|В документе способ зачета предоплаты можно изменить.'");
	НоваяНастройка.ТипРеквизита		= Новый ОписаниеТипов("ПеречислениеСсылка.СпособыЗачетаИРаспределенияПлатежей");
	НоваяНастройка.ТипЭлемента		= Тип("ПолеФормы");
	НоваяНастройка.СвойстваЭлемента	= Новый Структура;
	НоваяНастройка.СвойстваЭлемента.Вставить("Заголовок", НоваяНастройка.Представление);
	НоваяНастройка.СвойстваЭлемента.Вставить("Подсказка", НоваяНастройка.Описание);
	...
	НоваяНастройка.СвойстваЭлемента.Вставить("Вид", ВидПоляФормы.ПолеПереключателя);
	НоваяНастройка.СвойстваЭлемента.Вставить("ОтображениеПодсказки", ОтображениеПодсказки.Кнопка);
	МетаданныеПеречисления = Метаданные.НайтиПоТипу(Тип("ПеречислениеСсылка.СпособыЗачетаИРаспределенияПлатежей"));
	Если МетаданныеПеречисления <> Неопределено Тогда
		НоваяНастройка.СвойстваЭлемента.Вставить("СписокВыбора", Новый СписокЗначений);
		Для Каждого МетаданныеЗначения Из МетаданныеПеречисления.ЗначенияПеречисления Цикл
			НоваяНастройка.СвойстваЭлемента.СписокВыбора.Добавить(Перечисления[МетаданныеПеречисления.Имя][МетаданныеЗначения.Имя], МетаданныеЗначения.Синоним);
	...
	НоваяНастройка = ТаблицаНастроек.Добавить();
	НоваяНастройка.Идентификатор	= "СпособЗачетаПредоплатыПоУмолчанию";
	НоваяНастройка.Раздел			= "Деньги";
	НоваяНастройка.Представление	= НСтр("ru='Зачитывать предоплату'");
	НоваяНастройка.Описание			= НСтр("ru='Для установки значения на закладке ""Предоплата"" в расходной накладной, акте выполненных работ и др. документах.
		|В документе способ зачета предоплаты можно изменить.'");
	НоваяНастройка.ТипРеквизита		= Новый ОписаниеТипов("ПеречислениеСсылка.СпособыЗачетаИРаспределенияПлатежей");
	НоваяНастройка.ТипЭлемента		= Тип("ПолеФормы");
	...
	КонецЕсли;
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.ВместеС = "СпособРазнесенияОплатыПоУмолчанию";
	НоваяНастройка.Теги = НСтр("ru='Контрагенты,Договоры,Поступление в кассу,Поступление на счет,Операция по платежным картам,Расход из кассы,Расход со счета,Заказ покупателя,Заказ поставщику,Акт выполненных работ,Расходная накладная,Приходная накладная,Заказ-наряд,Счет на оплату,Счет на оплату (полученный),Дополнительные расходы'");
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуКоманда(ТаблицаНастроек,
		"НастроитьУчетныеЗаписи",
		"ПочтаSMS",
		НСтр("ru='Настроить учетные записи'"),
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуКоманда(ТаблицаНастроек,
		"НастройкаПодписиПисем",
		"ПочтаSMS",
		НСтр("ru='Настройка подписи писем'"),
		НСтр("ru='Подпись подставляется автоматически в текст исходящего электронного письма.'")
	);
	НоваяНастройка.ПравоРедактирования = Истина;
	НоваяНастройка.Теги = НСтр("ru='Событие,Контактные лица'");
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуГиперссылкаНавигации(ТаблицаНастроек,
		...
		"e1cib/command/ОбщаяКоманда.РедактируемыеФайлы"
	);
	НоваяНастройка.ПравоРедактирования = Истина;
	...
	Если РежимРаботы.ЭтоАдминистраторПрограммы И НЕ РежимРаботы.ЭтоМобильныйКлиент Тогда
		НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуКоманда(ТаблицаНастроек,
	...
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.ВместеС = "ИспользоватьСинхронизациюДанных";
	НоваяНастройка.Зависимости = "ИспользоватьСинхронизациюДанных,ИспользоватьДатыЗапретаЗагрузки";
	НоваяНастройка.Теги = НСтр("ru='Ввод начальных остатков,Начальные остатки организации'");
	...
	НоваяНастройка = ТаблицаНастроек.Добавить();
	НоваяНастройка.Идентификатор	= "ПрефиксШтрихкодовУзлаРИБ";
	НоваяНастройка.Раздел			= "Программы1СПредприятие";
	НоваяНастройка.Представление	= НСтр("ru='Префикс штрихкодов'");
	НоваяНастройка.Описание			= НСтр("ru='Этот префикс добавляется к штрихкодам номенклатуры, которые генерируются по кнопке ""Сгенерировать штрихкод"". Позволяет избежать дублирования в удаленных рабочих местах.'");
	НоваяНастройка.ТипРеквизита		= Новый ОписаниеТипов("Число");
	НоваяНастройка.ТипЭлемента		= Тип("ПолеФормы");
	НоваяНастройка.СвойстваЭлемента	= Новый Структура;
	НоваяНастройка.СвойстваЭлемента.Вставить("Заголовок", НоваяНастройка.Представление);
	...
	НоваяНастройка.ВместеС = "ИспользоватьСинхронизациюДанных";
	НоваяНастройка.Зависимости = "ИспользоватьСинхронизациюДанных";
	НоваяНастройка.Теги = НСтр("ru='Штрихкоды номенклатуры,Ввод начальных остатков,Начальные остатки организации'");
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		"ИспользоватьОнлайнОплаты",
		"ОбменССайтом",
		НСтр("ru='Использовать онлайн-оплаты'"),
		НСтр("ru='Позволяет загружать с сайта онлайн-оплаты и пробивать по ним чеки в Мониторе онлайн-оплат автоматически.
		|
		|ВАЖНО!
		|Для использования нужно включить опции:
		|Розничные продажи, Заказы покупателей в розничной торговле - в разделе Продажи
		|Подключаемое оборудование - в разделе Администрирование
		|
		|Для пробития онлайн-чеков нужны настройки:
		|Установить признак ""Загружать онлайн-оплаты"", настроить расписание и соответствия видов оплат - в узле обмена с сайтом.
		|Подключить и настроить ККТ в разделе Администрирование - Подключаемое оборудование
		|
		|ВАЖНО!
		|Для работы в автоматическом режиме, нужно держать открытым Монитор онлайн-оплат, в разделе CRM - Сайт компании.'")
	);
	НоваяНастройка.ОбновлятьИнтерфейс = Истина;
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.ВместеС = "ФункциональнаяОпцияИспользоватьОбменССайтами";
	НоваяНастройка.Зависимости = "ФункциональнаяОпцияИспользоватьОбменССайтами,ФункциональнаяОпцияУчетРозничныхПродаж,ФункциональнаяОпцияИспользоватьЗаказыВРозничнойТорговлеДляНастроек,ФункциональнаяОпцияИспользоватьПодключаемоеОборудование";
	НоваяНастройка.Теги = НСтр("ru='Кассы ККМ,Обмен Управление небольшой фирмой - Сайт,Операция по платежным картам,Подключаемое оборудование'");
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		...
		"БизнесСеть",
		НСтр("ru='Обмен данными 1С:Бизнес-сеть'"),
		НСтр("ru='Обмен электронными документами без электронной подписи,публикация и поиск торговых предложений в сервисе 1С:Бизнес-сеть.'")
	);
	НоваяНастройка.ОбновлятьИнтерфейс = Истина;
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуКоманда(ТаблицаНастроек,
		"ПодробнееОТорговыхПредложениях",
		"БизнесСеть",
		НСтр("ru='Подробнее о торговых предложениях'"),
		НСтр("ru='Руководство пользователя сервиса 1С:Бизнес-сеть. Торговые предложения'")
	);
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.Теги = НСтр("ru='Торговые,предложения,Торговые предложения'");
	
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуКоманда(ТаблицаНастроек,
		"ПубликацияТорговыхПредложений",
		"БизнесСеть",
		НСтр("ru='Настройка и публикация торговых предложений в 1С:Бизнес-сеть'"),
		НСтр("ru='Рабочее место по настройке и публикации торговых предложений.'")
	);
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.Теги = НСтр("ru='Торговые,предложения,Торговые предложения'");
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуКоманда(ТаблицаНастроек,
		...
		"БизнесСеть",
		НСтр("ru='Поиск предложений'"),
		НСтр("ru='Осуществляет поиск торговых предложений.'")
	);
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.Зависимости = "ИспользоватьОбменБизнесСеть";
	НоваяНастройка.Теги = НСтр("ru='Торговые,предложения,Торговые предложения'");
	
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		"ИспользоватьСервисРаботаСНоменклатурой",
		"1СНоменклатура",
		НСтр("ru='Использовать сервис 1С:Номенклатура'"),
		НСтр("ru='Поиск, загрузка и обновление номенклатуры и категорий номенклатуры из сервиса 1С:Номенклатура'")
	);
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуГиперссылкаНавигации(ТаблицаНастроек,
		"РаботаСНоменклатуройПанельАдминистрирования",
		"1СНоменклатура",
		НСтр("ru='Настройка параметров работы с сервисом 1С:Номенклатура.'"),
		НСтр("ru=''"),
	...
	Если Не РежимРаботы.МодельСервиса Тогда
		...
		НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
		НоваяНастройка.ВместеС = "ИспользоватьОбменЭД";
		НоваяНастройка.Зависимости = "АвтоматическоеПолучениеЭД,ИспользоватьОбменЭД";
		НоваяНастройка.Теги = НСтр("ru='Контрагенты'");
	КонецЕсли;
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		"ИспользоватьИнтеграциюСЯндексКассой",
		"ИнтеграцияСЯндексКассой",
		НСтр("ru='Яндекс.Касса'"),
		НСтр("ru='Выставлять счета и принимать платежи через сервис Яндекс.Касса'")
	);
	НоваяНастройка.ОбновлятьИнтерфейс = Истина;
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.Теги = НСтр("ru='Яндекс.Касса'");
	
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуКоманда(ТаблицаНастроек,
		"НастройкиЯндексКассы",
		"ИнтеграцияСЯндексКассой",
		НСтр("ru='Настройки Яндекс.Кассы'"),
		НСтр("ru='Настройки подключения к сервису Яндекс.Касса для выставления счетов и получения платежей'")
	);
	НоваяНастройка.ПравоРедактирования = Истина;
	НоваяНастройка.ВместеС = "ИспользоватьИнтеграциюСЯндексКассой";
	НоваяНастройка.Зависимости = "ИспользоватьИнтеграциюСЯндексКассой";
	НоваяНастройка.Теги = НСтр("ru='Яндекс.Касса'");
	
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуКоманда(ТаблицаНастроек,
		"СостояниеИнтеграцииЯндексКасса",
		"ИнтеграцияСЯндексКассой",
		НСтр("ru='Состояние обмена'"),
		НСтр("ru='Просмотр дат последнего обмена с Яндекс.Кассой'")
	);
	НоваяНастройка.ПравоРедактирования = Истина;
	НоваяНастройка.ВместеС = "ИспользоватьИнтеграциюСЯндексКассой";
	НоваяНастройка.Зависимости = "ИспользоватьИнтеграциюСЯндексКассой";
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуКоманда(ТаблицаНастроек,
		"ШаблоныСообщенийЯндексКасса",
		"ИнтеграцияСЯндексКассой",
		НСтр("ru='Шаблоны писем'"),
		НСтр("ru='Открыть список шаблонов'")
	);
	НоваяНастройка.ПравоРедактирования = Истина;
	НоваяНастройка.ВместеС = "ИспользоватьИнтеграциюСЯндексКассой";
	НоваяНастройка.Зависимости = "ИспользоватьИнтеграциюСЯндексКассой";
	НоваяНастройка.Теги = НСтр("ru='CRM,Событие,E-mail,SMS,Яндекс.Касса'");
	
	Если Не РежимРаботы.МодельСервиса И РежимРаботы.ЭтоАдминистраторПрограммы Тогда
		НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
			"ПолучатьУведомленияОтЯндексКассыАвтоматически",
			"ИнтеграцияСЯндексКассой",
			НСтр("ru='Автоматически получать уведомления от Яндекс.Кассы'"),
			НСтр("ru='Включает автоматическое получение уведомлений от сервиса Яндекс.Касса по расписанию '")
		);
		НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
		НоваяНастройка.ВместеС = "ИспользоватьИнтеграциюСЯндексКассой";
		НоваяНастройка.Зависимости = "ИспользоватьИнтеграциюСЯндексКассой";
	...
	Если Не РежимРаботы.МодельСервиса  Тогда
		НоваяНастройка = ТаблицаНастроек.Добавить();
		НоваяНастройка.Идентификатор	= "ПолучениеУведомленийОтЯндексКассыРасписание";
		НоваяНастройка.Раздел			= "ИнтеграцияСЯндексКассой";
		НоваяНастройка.Представление	= НСтр("ru='Расписание'");
		НоваяНастройка.ТипЭлемента		= Тип("ДекорацияФормы");
		НоваяНастройка.СвойстваЭлемента	= Новый Структура;
		НоваяНастройка.СвойстваЭлемента.Вставить("Заголовок", НоваяНастройка.Представление);
		...
		НоваяНастройка.СвойстваЭлемента.Вставить("ОтображениеПодсказки", ОтображениеПодсказки.Кнопка);
		НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
		НоваяНастройка.ВместеС = "ПолучатьУведомленияОтЯндексКассыАвтоматически";
		НоваяНастройка.Зависимости = "ИспользоватьИнтеграциюСЯндексКассой,ПолучатьУведомленияОтЯндексКассыАвтоматически";
		НоваяНастройка.Теги = НСтр("ru='Яндекс.Касса'");
	КонецЕсли;
	...
	НоваяНастройка.Теги = НСтр("ru='Версионирование,История изменений'");
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		...
		НСтр("ru='Разрешить добавление реквизитов у которых общий список значений с другими реквизитами.'")
	);
	НоваяНастройка.ОбновлятьИнтерфейс = Истина;
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.Теги = НСтр("ru='Характеристики,Дополнительные реквизиты и сведения'");
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуКоманда(ТаблицаНастроек,
		"НастройкаСкрытияПерсональныхДанных",
		"ЗащитаПерсональныхДанных",
		НСтр("ru='Настройка скрытия персональных данных'"),
		НСтр("ru='При включении опции, по истечении указанного срока, будут безвозвратно удалены персональные данные физических лиц, которые не принимались на работу в нашу организацию. К таким данным относятся дни рождения, пол и сведения о персональных документах, например, паспорта и водительские удостоверения.'")
	);
	НоваяНастройка.ПравоРедактирования = НЕ ОбщегоНазначения.ЭтоПодчиненныйУзелРИБ() И РежимРаботы.ЭтоАдминистраторПрограммы;
	
	Если ИнтернетПоддержкаПользователейВызовСервера.ДоступноПодключениеИнтернетПоддержки() Тогда
		НоваяНастройка = ТаблицаНастроек.Добавить();
		НоваяНастройка.Идентификатор	= "СостояниеПодключенияИПП";
		НоваяНастройка.Раздел			= "ИнтернетПоддержкаПользователей";
		НоваяНастройка.Представление	= НСтр("ru='Состояние подключения ИПП'");
		НоваяНастройка.ТипРеквизита		= Новый ОписаниеТипов("Строка");
		НоваяНастройка.ТипЭлемента		= Тип("ПолеФормы");
		НоваяНастройка.СвойстваЭлемента	= Новый Структура;
		НоваяНастройка.СвойстваЭлемента.Вставить("Заголовок", НоваяНастройка.Представление);
	...
	Если ИнтернетПоддержкаПользователейВызовСервера.ДоступноПодключениеИнтернетПоддержки() Тогда
		...
		НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
		НоваяНастройка.ВместеС = "СостояниеПодключенияИПП";
	КонецЕсли;
	
	Если МониторПортала1СИТС.ДоступноИспользованиеМонитора() Тогда
		НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуКоманда(ТаблицаНастроек,
			"МониторПортала1СИТС",
			"ИнтернетПоддержкаПользователей",
	...
	Если ПолучениеОбновленийПрограммы.ДоступноИспользованиеОбновленияПрограммы() Тогда
		НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуКоманда(ТаблицаНастроек,
			...
			НСтр("ru='Обновление программы из файла на локальном диске, в сетевом каталоге или установка исправлений (патчей).'")
		);
		НоваяНастройка.ДобавлятьОтступ = Истина;
		НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторСистемы;
	КонецЕсли;
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуКоманда(ТаблицаНастроек,
		...
		"ИнтернетПоддержкаПользователей",
		НСтр("ru='Описание изменений программы'"),
		НСтр("ru='История изменений по версиям программы.'")
	);
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	...
	Если РежимРаботы.ЭтоАдминистраторПрограммы 
			...
			И ОбщегоНазначения.ЭтоWindowsКлиент() Тогда
		НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуКоманда(ТаблицаНастроек,
			"УстановкаОбновленийИсправлений",
			"ИнтернетПоддержкаПользователей",
			НСтр("ru='Установка обновлений и исправлений (патчей)'"),
			НСтр("ru='Обновление программы из файла на локальном диске, в сетевом каталоге или установка исправлений (патчей).'")
		);
		НоваяНастройка.ДобавлятьОтступ = Истина;
		НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	...
	Если РежимРаботы.ЭтоАдминистраторПрограммы 
			...
			И ОбщегоНазначения.ЭтоWindowsКлиент() Тогда
		НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуКоманда(ТаблицаНастроек,
			"УстановленныеИсправленияОткрыть",
			"ИнтернетПоддержкаПользователей",
			НСтр("ru='Установленные исправления (патчи)'"),
			НСтр("ru='Список установленных в программе исправлений.'")
		);
		НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	КонецЕсли;
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		...
		"ИнтернетПоддержкаПользователей",
		НСтр("ru='Загружать и устанавливать исправления автоматически'"),
		НСтр("ru='Получение информации, загрузка и установка доступных исправлений (патчей) конфигурации в ""тихом режиме"" без участия пользователя.'")
	);
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	
	Если ОбщегоНазначения.ИнформационнаяБазаФайловая() И ПолучениеОбновленийПрограммы.ДоступноИспользованиеОбновленияПрограммы(Истина) И Не ПустаяСтрока(ПолучениеОбновленийПрограммы.КаталогСохраненияПоследнегоПолученногоДистрибутива()) Тогда
		НоваяНастройка = ТаблицаНастроек.Добавить();
	...
	Если РежимРаботы.ЭтоАдминистраторСистемы И (НЕ ОбщегоНазначения.РазделениеВключено() ИЛИ НЕ ОбщегоНазначения.ДоступноИспользованиеРазделенныхДанных()) Тогда
		НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
	...
	Если РежимРаботы.ЭтоАдминистраторСистемы И (Не ОбщегоНазначения.ЭтоАвтономноеРабочееМесто()
		И Не ОбщегоНазначения.РазделениеВключено()
	...
	Если НЕ РежимРаботы.МодельСервиса Тогда
		НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
			...
			"ИнтернетПоддержкаПользователей",
			НСтр("ru='Склонять ФИО с помощью сервиса morpher.ru'"),
			НСтр("ru='Использовать сервис склонения Морфер для получения представлений ФИО и должностей в падежах (требуется подключение к Интернет).
		|
		|В платформе 1С:Предприятие 8.3.13 появилась возможность склонений без подключения сервиса.'")
		);
		НоваяНастройка.ДобавлятьОтступ = Истина;
		НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	КонецЕсли;
	...
	Если НЕ РежимРаботы.МодельСервиса Тогда
		НоваяНастройка = ТаблицаНастроек.Добавить();
		НоваяНастройка.Идентификатор	= "НастройкаДоступаКСервисуСклонения";
		НоваяНастройка.Раздел			= "ИнтернетПоддержкаПользователей";
		НоваяНастройка.Представление	= НСтр("ru='Настройка доступа к сервису morpher'");
		НоваяНастройка.ТипЭлемента		= Тип("ДекорацияФормы");
		НоваяНастройка.СвойстваЭлемента	= Новый Структура;
		НоваяНастройка.СвойстваЭлемента.Вставить("Заголовок", НоваяНастройка.Представление);
		НоваяНастройка.СвойстваЭлемента.Вставить("Вид", ВидДекорацииФормы.Надпись);
		НоваяНастройка.СвойстваЭлемента.Вставить("Гиперссылка", Истина);
		НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
		НоваяНастройка.ВместеС = "ИспользоватьСервисСклоненияMorpher";
		НоваяНастройка.Зависимости = "ИспользоватьСервисСклоненияMorpher";
	КонецЕсли;
	...
	Если РаботаСКлассификаторами.ИнтерактивнаяЗагрузкаКлассификаторовДоступна() Тогда
		НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуКоманда(ТаблицаНастроек,
			...
			НСтр("ru='Обновление классификаторов из файла на локальном диске, в сетевом каталоге или загрузка с Портала 1С:ИТС.'")
		);
		НоваяНастройка.ДобавлятьОтступ = Истина;
		НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	КонецЕсли;
	...
	Если РежимРаботы.Локальный И РежимРаботы.ЭтоАдминистраторСистемы Тогда
		НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуГиперссылкаНавигации(ТаблицаНастроек,
			...
			НСтр("ru='Загрузка классификатора банков РФ с Портала 1С:ИТС или диска 1С:ИТС.'"),
			"e1cib/command/Обработка.ЗагрузкаКлассификатораБанков.Команда.ЗагрузкаКлассификатораБанков"
		);
		НоваяНастройка.ПравоРедактирования = Истина;
		НоваяНастройка.Теги = НСтр("ru='Банковские счета'");
	КонецЕсли;
	...
	Если РежимРаботы.Локальный Тогда
		НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуГиперссылкаНавигации(ТаблицаНастроек,
			...
			НСтр("ru='Загрузка курсов выбранных валют за указанный период с Портала 1С:ИТС.'"),
	...
	Если РежимРаботы.Локальный Или РежимРаботы.Автономный Тогда
		НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуГиперссылкаНавигации(ТаблицаНастроек,
			...
			НСтр("ru='Для экономии трафика при автоподборе и проверке адресов, а также при работе без доступа к Интернету возможно загружать и обновлять адресные сведения в программу. Требуется до 2 Гб места на диске.'"),
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		...
		"НастройкиПользователейИПрав",
		НСтр("ru='Группы доступа контактов и контрагентов'"),
		НСтр("ru='Позволяет разделить контакты и контрагентов на группы, по которым можно установить права для пользователей на просмотр, добавление(изменение), а так же разграничить доступ по всем связанным с ними документам.'")
	);
	НоваяНастройка.ОбновлятьИнтерфейс = Истина;
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.ВместеС = "ОграничиватьДоступНаУровнеЗаписей";
	НоваяНастройка.Зависимости = "ОграничиватьДоступНаУровнеЗаписей";
	НоваяНастройка.Теги = НСтр("ru='Контрагенты,Контакты,Контактные лица'");
	
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуГиперссылкаНавигации(ТаблицаНастроек,
		"ОткрытьГруппыДоступаКонтрагентов",
		"НастройкиПользователейИПрав",
		НСтр("ru='Группы доступа контактов и контрагентов'"),
		НСтр("ru='Создание групп доступа контактов и контрагентов.'"),
		"e1cib/list/Справочник.ГруппыДоступаКонтрагентов"
	);
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.ВместеС = "ОграничиватьДоступНаУровнеЗаписей";
	НоваяНастройка.Зависимости = "ИспользоватьГруппыДоступаКонтрагентов,ОграничиватьДоступНаУровнеЗаписей";
	НоваяНастройка.Теги = НСтр("ru='Контрагенты,Контакты,Контактные лица'");
	
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
		"ИспользоватьГруппыДоступаЛидов",
		"НастройкиПользователейИПрав",
		НСтр("ru='Группы доступа лидов'"),
		НСтр("ru='Деление лидов на группы, по которым можно назначать пользователям права на добавление(изменение) и просмотр'")
	);
	НоваяНастройка.ОбновлятьИнтерфейс = Истина;
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.ВместеС = "ОграничиватьДоступНаУровнеЗаписей";
	НоваяНастройка.Зависимости = "ОграничиватьДоступНаУровнеЗаписей";
	НоваяНастройка.Теги = НСтр("ru='Контрагенты,Контакты,Контактные лица,Лиды'");
	
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуГиперссылкаНавигации(ТаблицаНастроек,
		"ОткрытьГруппыДоступаЛидов",
		"НастройкиПользователейИПрав",
		НСтр("ru='Группы доступа лидов'"),
		НСтр("ru='Создание групп доступа лидов.'"),
		"e1cib/list/Справочник.ГруппыДоступаЛидов"
	);
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.ВместеС = "ОграничиватьДоступНаУровнеЗаписей";
	НоваяНастройка.Зависимости = "ОграничиватьДоступНаУровнеЗаписей,ИспользоватьГруппыДоступаЛидов";
	НоваяНастройка.Теги = НСтр("ru='Контрагенты,Контакты,Контактные лица,Лиды'");
	...
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуГиперссылкаНавигации(ТаблицаНастроек,
		...
		"ПечатныеФормыОтчетыОбработки",
		НСтр("ru='Настройка колонтитулов'"),
		НСтр("ru='Установка номеров страниц, даты и других полей в колонтитулах отчетов при печати.'"),
	...
	НоваяНастройка = ТаблицаНастроек.Добавить();
	НоваяНастройка.Идентификатор	= "ДобавитьСловоДоговорВПредставлениеДоговораОснованияПечати";
	НоваяНастройка.Раздел			= "ПечатныеФормыОтчетыОбработки";
	НоваяНастройка.Представление	= НСтр("ru='Добавить слово договор в представление договора основания печати'");
	...
	НоваяНастройка = ТаблицаНастроек.Добавить();
	НоваяНастройка.Идентификатор	= "ПредставлениеКодовВПечатныхФормах";
	НоваяНастройка.Раздел			= "ПечатныеФормыОтчетыОбработки";
	НоваяНастройка.Представление	= НСтр("ru='Представление кодов в печатных формах'");
	НоваяНастройка.ТипРеквизита		= Новый ОписаниеТипов("ПеречислениеСсылка.КодыНоменклатурыВДокументах");
	НоваяНастройка.ТипЭлемента		= Тип("ПолеФормы");
	НоваяНастройка.СвойстваЭлемента	= Новый Структура;
	НоваяНастройка.СвойстваЭлемента.Вставить("Заголовок", НоваяНастройка.Представление);
	НоваяНастройка.ДобавлятьОтступ = Истина;
	...
	НоваяНастройка = ТаблицаНастроек.Добавить();
	НоваяНастройка.Идентификатор	= "ПредставлениеСкидкиВПечатнойФорме";
	НоваяНастройка.Раздел			= "ПечатныеФормыОтчетыОбработки";
	НоваяНастройка.Представление	= НСтр("ru='Представление скидки в печатной форме'");
	НоваяНастройка.ТипРеквизита		= Новый ОписаниеТипов("ПеречислениеСсылка.СпособОтображенияСкидок");
	НоваяНастройка.ТипЭлемента		= Тип("ПолеФормы");
	НоваяНастройка.СвойстваЭлемента	= Новый Структура;
	НоваяНастройка.СвойстваЭлемента.Вставить("Заголовок", НоваяНастройка.Представление);
	НоваяНастройка.СвойстваЭлемента.Вставить("Вид", ВидПоляФормы.ПолеВвода);
	...
	НоваяНастройка = ТаблицаНастроек.Добавить();
	НоваяНастройка.Идентификатор	= "ГруппаНомерНаПечать";
	НоваяНастройка.Раздел			= "ПечатныеФормыОтчетыОбработки";
	НоваяНастройка.Представление	= НСтр("ru='Настройка печати номеров документов'");
	НоваяНастройка.ТипЭлемента		= Тип("ДекорацияФормы");
	НоваяНастройка.СвойстваЭлемента	= Новый Структура;
	НоваяНастройка.СвойстваЭлемента.Вставить("Заголовок", НоваяНастройка.Представление);
	НоваяНастройка.СвойстваЭлемента.Вставить("Вид", ВидДекорацииФормы.Надпись);
	...
	НоваяНастройка = ТаблицаНастроек.Добавить();
	НоваяНастройка.Идентификатор	= "ПредставлениеНомераДокументаБезПрефиксаИнформационнойБазы";
	НоваяНастройка.Раздел			= "ПечатныеФормыОтчетыОбработки";
	НоваяНастройка.Представление	= НСтр("ru='Исключить префикс информационной базы'");
	НоваяНастройка.ТипРеквизита		= Новый ОписаниеТипов("Булево");
	НоваяНастройка.ТипЭлемента		= Тип("ПолеФормы");
	НоваяНастройка.СвойстваЭлемента	= Новый Структура;
	НоваяНастройка.СвойстваЭлемента.Вставить("Заголовок", НоваяНастройка.Представление);
	...
	НоваяНастройка.ОбновлятьИнтерфейс = Истина;
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.ВместеС = "ГруппаНомерНаПечать";
	
	НоваяНастройка = ТаблицаНастроек.Добавить();
	НоваяНастройка.Идентификатор	= "ПредставлениеНомераДокументаБезПрефиксаОрганизации";
	НоваяНастройка.Раздел			= "ПечатныеФормыОтчетыОбработки";
	НоваяНастройка.Представление	= НСтр("ru='Исключить префикс организации'");
	НоваяНастройка.ТипРеквизита		= Новый ОписаниеТипов("Булево");
	НоваяНастройка.ТипЭлемента		= Тип("ПолеФормы");
	НоваяНастройка.СвойстваЭлемента	= Новый Структура;
	НоваяНастройка.СвойстваЭлемента.Вставить("Заголовок", НоваяНастройка.Представление);
	...
	НоваяНастройка = ТаблицаНастроек.Добавить();
	НоваяНастройка.Идентификатор	= "ПредставлениеНомераДокументаБезПрефиксаПользователя";
	НоваяНастройка.Раздел			= "ПечатныеФормыОтчетыОбработки";
	НоваяНастройка.Представление	= НСтр("ru='Исключить пользовательский префикс'");
	НоваяНастройка.ТипРеквизита		= Новый ОписаниеТипов("Булево");
	НоваяНастройка.ТипЭлемента		= Тип("ПолеФормы");
	НоваяНастройка.СвойстваЭлемента	= Новый Структура;
	НоваяНастройка.СвойстваЭлемента.Вставить("Заголовок", НоваяНастройка.Представление);
	...
	НоваяНастройка = ТаблицаНастроек.Добавить();
	НоваяНастройка.Идентификатор	= "ПредставлениеНомераДокументаСЛидирующимиНулями";
	НоваяНастройка.Раздел			= "ПечатныеФормыОтчетыОбработки";
	НоваяНастройка.Представление	= НСтр("ru='Сохранить лидирующие нули'");
	НоваяНастройка.ТипРеквизита		= Новый ОписаниеТипов("Булево");
	НоваяНастройка.ТипЭлемента		= Тип("ПолеФормы");
	НоваяНастройка.СвойстваЭлемента	= Новый Структура;
	НоваяНастройка.СвойстваЭлемента.Вставить("Заголовок", НоваяНастройка.Представление);
	...
	НоваяНастройка = ТаблицаНастроек.Добавить();
	НоваяНастройка.Идентификатор	= "КонтактнаяИнформацияТоварногоЧека";
	НоваяНастройка.Раздел			= "ПечатныеФормыОтчетыОбработки";
	НоваяНастройка.Представление	= НСтр("ru='Контактная информация товарного чека'");
	НоваяНастройка.ТипРеквизита		= Новый ОписаниеТипов("ПеречислениеСсылка.КонтактнаяИнформацияТоварногоЧека");
	НоваяНастройка.ТипЭлемента		= Тип("ПолеФормы");
	НоваяНастройка.СвойстваЭлемента	= Новый Структура;
	НоваяНастройка.СвойстваЭлемента.Вставить("Заголовок", НоваяНастройка.Представление);
	НоваяНастройка.СвойстваЭлемента.Вставить("Вид", ВидПоляФормы.ПолеВвода);
	...
	Если Не РежимРаботы.ЭтоLinuxКлиент Тогда
		НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуФлаг(ТаблицаНастроек,
			"ИспользоватьОнлайнПоддержку",
			"ПоддержкаИОбслуживание",
			НСтр("ru='Онлайн-поддержка'"),
			НСтр("ru='Разрешить запуск приложения для соединения со специалистом онлайн-поддержки.'")
		);
		НоваяНастройка.ДобавлятьОтступ = Истина;
		НоваяНастройка.ОбновлятьИнтерфейс = Истина;
		НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
		НоваяНастройка.Теги = НСтр("ru='бухфон'");
	КонецЕсли;
	...
	Если Не РежимРаботы.ЭтоLinuxКлиент Тогда
		НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуГиперссылкаНавигации(ТаблицаНастроек,
			...
			"ПоддержкаИОбслуживание",
			НСтр("ru='Настройка онлайн-поддержки'"),
			НСтр("ru='Настройка запуска приложения на этом компьютере.'"),
			"e1cib/command/ОбщаяКоманда.НастройкаОнлайнПоддержки"
		);
		НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
		НоваяНастройка.ВместеС = "ИспользоватьОнлайнПоддержку";
		НоваяНастройка.Зависимости = "ИспользоватьОнлайнПоддержку";
		НоваяНастройка.Теги = НСтр("ru='бухфон'");
	КонецЕсли;
	...
	НоваяНастройка.Зависимости = "ИспользоватьОбменСПодключаемымОборудованиемOffline,ФункциональнаяОпцияИспользоватьПодключаемоеОборудование";
	НоваяНастройка.Теги = НСтр("ru='Заказ покупателя'");
	
	НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуГиперссылкаНавигации(ТаблицаНастроек,
		"НастройкаДиапазоновSKUВесовогоТовара",
		"ПодключаемоеОборудование",
		НСтр("ru='Настройка диапазонов SKU весового товара'"),
		НСтр("ru='Для весового товара необходимо назначить диапазон SKU, который будет использоваться на весах в качестве кода товара'"),
		"e1cib/list/ОбщаяФорма.НастройкаДиапазоновSKU"
	);
	НоваяНастройка.ПравоРедактирования = РежимРаботы.ЭтоАдминистраторПрограммы;
	НоваяНастройка.ВместеС = "ИспользоватьОбменСПодключаемымОборудованиемOffline";
	НоваяНастройка.Зависимости = "ИспользоватьОбменСПодключаемымОборудованиемOffline,ФункциональнаяОпцияИспользоватьПодключаемоеОборудование";
	...
	Если РежимРаботы.ЭтоАдминистраторСистемы Тогда
		НоваяНастройка = Обработки.НастройкаПрограммы.ДобавитьНастройкуКоманда(ТаблицаНастроек,
			...
			НСтр("ru='Управление поиском в документах, файлах, отчетах.'")
		);
		НоваяНастройка.ПравоРедактирования = Истина;
	КонецЕсли;
...
Процедура ПриПолученииЗначенияНастройки(знач Идентификатор, Значение, СтандартнаяОбработка) Экспорт
	...
	Если Идентификатор = "ИспользоватьТелефонию" Тогда
		
		Значение = Константы.ИспользоватьМобильнуюТелефонию.Получить() ИЛИ Константы.ИспользоватьОблачнуюТелефонию.Получить()
		
	ИначеЕсли Идентификатор = "КонтрольДоговоровКонтрагентов" Тогда
		
		КонтрольДоговоров = Константы.ФункциональнаяОпцияКонтрольДоговоров.Получить();
Если КонтрольДоговоров = Перечисления.ВидыКонтроляДоговоровПриПроведении.НеПроводить Тогда
	Значение = 3;
ИначеЕсли КонтрольДоговоров = Перечисления.ВидыКонтроляДоговоровПриПроведении.Предупреждать Тогда
	Значение = 2;
ИначеЕсли КонтрольДоговоров = Перечисления.ВидыКонтроляДоговоровПриПроведении.НеКонтролировать Тогда
	Значение = 1;
КонецЕсли;

		
	ИначеЕсли Идентификатор = "РегистрацияВзаимодействия" Тогда
		
		Значение = СистемаВзаимодействия.ИнформационнаяБазаЗарегистрирована();
		
	ИначеЕсли Идентификатор = "КонтрагентДляПредоплаты" Тогда
		
		Значение = Константы.КонтрагентДляПодарочныхСертификатов.Получить()
...
//		Значение = ?(РегЗадание = Неопределено, Неопределено, РегЗадание.Использование);
	...
	ИначеЕсли Идентификатор = "ПолучатьУведомленияОтЯндексКассыАвтоматически" Тогда
		
		Значение = ИнтеграцияСЯндексКассойУНФ.ПолучитьСостояниеРегламентногоЗаданияЯндексКасса();
		
	ИначеЕсли Идентификатор = "ИспользоватьВерсионированиеОбъектов" Тогда
		
		Если ОбщегоНазначения.ПодсистемаСуществует("СтандартныеПодсистемы.ВерсионированиеОбъектов") Тогда
		МодульВерсионированиеОбъектов = ОбщегоНазначения.ОбщийМодуль("ВерсионированиеОбъектов");
		Значение = МодульВерсионированиеОбъектов.ЗначениеФлажкаХранитьИсторию();
	КонецЕсли;
		
	ИначеЕсли Идентификатор = "СостояниеПодключенияИПП" Тогда
		
		Значение = ИнтернетПоддержкаПользователейПереопределяемый.СостояниеПодключенияИПП();
	...
	ИначеЕсли Идентификатор = "МаксимальныйРазмерФайла" Тогда
		...
		Значение = РаботаСФайлами.МаксимальныйРазмерФайлаОбщий() / (1024*1024);
		
	ИначеЕсли Идентификатор = "МаксимальныйРазмерФайлаОбластиДанных" Тогда
		
		Значение = РаботаСФайлами.МаксимальныйРазмерФайла() / (1024*1024);
...
КонецЕсли;
	...
	ИначеЕсли Идентификатор = "ФункциональнаяОпцияИспользоватьПодарочныеСертификаты" Тогда
...
КонецЕсли;
	...
	ИначеЕсли Идентификатор = "ФункциональнаяОпцияИспользоватьНаборы" Тогда
...
КонецЕсли;
	...
	ИначеЕсли Идентификатор = "ФункциональнаяОпцияРазрешитьСкладыВТабличныхЧастях" Тогда
...
КонецЕсли;
	...
	ИначеЕсли Идентификатор = "ФункциональнаяОпцияИспользоватьЭтапыПроизводства" Тогда
	...
	ИначеЕсли Идентификатор = "ФункциональнаяОпцияПлатежныйКалендарь" Тогда
	...
	ИначеЕсли Идентификатор = "ФункциональнаяОпцияИспользоватьРезервированиеДенежныхСредств" Тогда
...
Процедура ПриУстановкеЗначенияНастройки(знач Идентификатор, НовоеЗначение, ОповещенияНаКлиенте, СтандартнаяОбработка) Экспорт
	...
	ИначеЕсли Идентификатор = "ФункциональнаяОпцияИспользоватьОтчетность" Тогда
		
		СтандартнаяОбработка = Истина;
		Если НовоеЗначение Тогда
			Константы.ВестиРасчетыПоДокументам.Установить(Истина);
			Обработки.НастройкаПрограммы.ДобавитьОповещение(ОповещенияНаКлиенте, "Запись_НаборКонстант", Новый Структура, "ВестиРасчетыПоДокументам");
		КонецЕсли;
	...
	ИначеЕсли Идентификатор = "ИспользоватьТелефонию" Тогда
	...
	КонтрольДоговоров = Перечисления.ВидыКонтроляДоговоровПриПроведении.НеПроводить;
ИначеЕсли НовоеЗначение = 2 Тогда
	КонтрольДоговоров = Перечисления.ВидыКонтроляДоговоровПриПроведении.Предупреждать;
Иначе
	КонтрольДоговоров = Перечисления.ВидыКонтроляДоговоровПриПроведении.НеКонтролировать;
КонецЕсли;

	Константы.ФункциональнаяОпцияКонтрольДоговоров.Установить(КонтрольДоговоров);

		
	ИначеЕсли Идентификатор = "РегистрацияВзаимодействия" Тогда
		
		НовоеЗначение = СистемаВзаимодействия.ИнформационнаяБазаЗарегистрирована();
Обработки.НастройкаПрограммы.ДобавитьДействиеНаКлиенте(ОповещенияНаКлиенте, "ПерейтиПоНавигационнойСсылке", "e1cib/command/Обработка.РегистрацияВСистемеВзаимодействияУНФ.Команда.РегистрацияВзаимодействий");
		
	ИначеЕсли Идентификатор = "ИспользоватьЧатВОбсуждениях" Тогда
		
		СтандартнаяОбработка = Истина;
Если НовоеЗначение Тогда
	ОбновитьПовторноИспользуемыеЗначения();
	Обработки.НастройкаПрограммы.ДобавитьОповещение(ОповещенияНаКлиенте, "Запись_НаборКонстант", Новый Структура, "ИспользоватьЧатВОбсуждениях");
КонецЕсли;
...
Если НовоеЗначение И Не Константы.ФункциональнаяОпцияИспользоватьАвтоматическиеСкидкиНаценки.Получить() Тогда
	...
	Обработки.НастройкаПрограммы.ДобавитьОповещение(ОповещенияНаКлиенте, "Запись_НаборКонстант", Новый Структура, "ФункциональнаяОпцияИспользоватьАвтоматическиеСкидкиНаценки");
	ДисконтныеКартыСервер.ПроверитьИСоздатьУсловиеПоДисконтнойКарте();
КонецЕсли;
		
	ИначеЕсли Идентификатор = "ФункциональнаяОпцияИспользоватьБонусныеПрограммы" Тогда
...
Если НовоеЗначение И Не Константы.ФункциональнаяОпцияИспользоватьДисконтныеКарты.Получить() Тогда
	...
	Обработки.НастройкаПрограммы.ДобавитьОповещение(ОповещенияНаКлиенте, "Запись_НаборКонстант", Новый Структура, "ФункциональнаяОпцияИспользоватьДисконтныеКарты");
КонецЕсли;
Если НовоеЗначение Тогда
...
Если НовоеЗначение Тогда
	...
	Обработки.НастройкаПрограммы.ДобавитьОповещение(ОповещенияНаКлиенте, "Запись_НаборКонстант", Новый Структура, "КонтрагентДляПредоплаты");
КонецЕсли;
	...
	ИначеЕсли Идентификатор = "ФункциональнаяОпцияИспользоватьЧастичноеПогашениеСертификатов" Тогда
...
Если НовоеЗначение Тогда
	...
	Обработки.НастройкаПрограммы.ДобавитьОповещение(ОповещенияНаКлиенте, "Запись_НаборКонстант", Новый Структура, "КонтрольОстатковСерийныхНомеров");
КонецЕсли;
...
Если НовоеЗначение Тогда
	...
	Обработки.НастройкаПрограммы.ДобавитьОповещение(ОповещенияНаКлиенте, "Запись_НаборКонстант", Новый Структура, 			"ФункциональнаяОпцияИспользоватьОплатуКартами");
// Если нет движений оплаты платёжными картами и
...
Константы.ФункциональнаяОпцияИспользоватьЗаказыВРозничнойТорговле.Установить(НовоеЗначение И Константы.ФункциональнаяОпцияУчетРозничныхПродаж.Получить());
	...
	ИначеЕсли Идентификатор = "ВариантВозвратаПоЗакрытойСмене" Тогда
...
КонецЕсли;
	...
	ИначеЕсли Идентификатор = "ФункциональнаяОпцияИспользоватьОплатуКартамиВОптовойТорговле" Тогда
...
КонецЕсли;
	...
	ИначеЕсли Идентификатор = "ФункциональнаяОпцияИспользоватьОплатуКредитом" Тогда
...
ПерсональныеНастройки.Вставить("ЗапрашиватьПодтверждениеПриЗавершенииПрограммы", НовоеЗначение);
...
//		РегЗадание.Записать();
	...
	ИначеЕсли Идентификатор = "ПолучатьУведомленияОтЯндексКассыАвтоматически" Тогда
		...
		ИнтеграцияСЯндексКассойУНФ.ИзменитьСостояниеРегламентногоЗаданияЯндексКасса(НовоеЗначение);
	...
	ИначеЕсли Идентификатор = "ИспользоватьСервисСклоненияMorpher" Тогда
		
		Константы.ИспользоватьСервисСклоненияMorpher.Установить(НовоеЗначение);
СклонениеПредставленийОбъектов.УстановитьДоступностьСервисаСклонения(Истина);
	...
	ИначеЕсли Идентификатор = "ОграничиватьДоступНаУровнеЗаписей" Тогда
		...
		Если НовоеЗначение = Ложь Тогда
			...
			Константы.ИспользоватьГруппыДоступаЛидов.Установить(Ложь);
			Обработки.НастройкаПрограммы.ДобавитьОповещение(ОповещенияНаКлиенте, "Запись_НаборКонстант", Новый Структура, "ИспользоватьГруппыДоступаЛидов");
		КонецЕсли;
...
Процедура ПриОпределенииДоступности(знач Идентификатор, ЭлементФормы, Форма) Экспорт
	...
	ИначеЕсли Идентификатор = "ФункциональнаяОпцияИспользоватьАвтоматическиеОкругления" Тогда
		
		ЭлементФормы.Доступность = Форма.ФункциональнаяОпцияИспользоватьАвтоматическиеСкидкиНаценки
		
	ИначеЕсли Идентификатор = "КонтрагентДляПредоплаты" Тогда
		
		ЭлементФормы.Доступность = Форма.ФункциональнаяОпцияИспользоватьПодарочныеСертификаты;
	...
	ИначеЕсли Идентификатор = "АрхивироватьЧекиККМПриЗакрытииКассовойСмены" Тогда
		...
		ЭлементФормы.Доступность = Форма.ФункциональнаяОпцияУчетРозничныхПродаж И НЕ Форма.ФункциональнаяОпцияИспользоватьПредоплатуВЧекахККМ;
	...
	ИначеЕсли Идентификатор = "ФункциональнаяОпцияИспользоватьПредоплатуВЧекахККМ" Тогда
		
		ЭлементФормы.Доступность = Форма.ФункциональнаяОпцияУчетРозничныхПродаж И Не Форма.АрхивироватьЧекиККМПриЗакрытииКассовойСмены;
	...
	ИначеЕсли Идентификатор = "ФункциональнаяОпцияРазрешитьСкладыВТабличныхЧастях" Тогда
		...
		ЭлементФормы.Доступность = Форма.ФункциональнаяОпцияУчетПоНесколькимСкладам
	...
	ИначеЕсли Идентификатор = "ТребоватьЗаполнениеГТДИмпортногоТовара" Тогда
	...
	ИначеЕсли Идентификатор = "ФункциональнаяОпцияПланироватьЗагрузкуРесурсовПредприятияРаботы" Тогда
		
		ЭлементФормы.Доступность = Форма.ФункциональнаяОпцияИспользоватьПодсистемуРаботы;
		
	ИначеЕсли Идентификатор = "ФункциональнаяОпцияИспользоватьЭтапыПроизводства" Тогда
		
		ЭлементФормы.Доступность = Форма.ФункциональнаяОпцияИспользоватьПодсистемуПроизводство И Форма.ФункциональнаяОпцияРезервированиеЗапасов;
		
	ИначеЕсли Идентификатор = "ФункциональнаяОпцияВыполнениеЭтаповРазнымиПодразделениями" Тогда
		
		ЭлементФормы.Доступность = Форма.ФункциональнаяОпцияИспользоватьЭтапыПроизводства И Форма.ФункциональнаяОпцияУчетПоНесколькимПодразделениям;
		
	ИначеЕсли Идентификатор = "ФункциональнаяОпцияИспользоватьТехоперации" Тогда
		
		ЭлементФормы.Доступность = Форма.ФункциональнаяОпцияИспользоватьПодсистемуПроизводство;
		
	ИначеЕсли Идентификатор = "АвтоматическиПланироватьОперацийЗаказомНаПроизводство" Тогда
		
		ЭлементФормы.Доступность = Форма.ФункциональнаяОпцияИспользоватьТехоперации;
	...
	ИначеЕсли Идентификатор = "ФункциональнаяОпцияПланироватьЗагрузкуРесурсовПредприятия" Тогда
	...
	ИначеЕсли Идентификатор = "ФункциональнаяОпцияИспользоватьРезервированиеДенежныхСредств" Тогда
		...
		ЭлементФормы.Доступность = Форма.ФункциональнаяОпцияПлатежныйКалендарь;
Если НЕ ЭлементФормы.Доступность Тогда 
	Константы.ФункциональнаяОпцияИспользоватьРезервированиеДенежныхСредств.Установить(Ложь);
КонецЕсли;
	...
	ИначеЕсли Идентификатор = "ВестиРасчетыПоДокументам" Тогда
		
		ЭлементФормы.Доступность = НЕ Форма.ФункциональнаяОпцияИспользоватьОтчетность;
	...
	ИначеЕсли Идентификатор = "ПрефиксШтрихкодовУзлаРИБ" Тогда
	...
	ИначеЕсли Идентификатор = "ИспользоватьОнлайнОплаты" Тогда
		
		ЭлементФормы.Доступность = Форма.ФункциональнаяОпцияИспользоватьОбменССайтами 
И Форма.ФункциональнаяОпцияУчетРозничныхПродаж
И Форма.ФункциональнаяОпцияИспользоватьЗаказыВРозничнойТорговлеДляНастроек
И Форма.ФункциональнаяОпцияИспользоватьПодключаемоеОборудование
;
		
	ИначеЕсли Идентификатор = "ПоискТорговыхПредложений" Тогда
		
		ЭлементФормы.Доступность = Форма.ИспользоватьОбменБизнесСеть;
	...
	ИначеЕсли Идентификатор = "НастройкиЯндексКассы" Тогда
		...
		ЭлементФормы.Доступность = Форма.ИспользоватьИнтеграциюСЯндексКассой;
...
КонецЕсли;
	...
	ИначеЕсли Идентификатор = "ПолучениеУведомленийОтЯндексКассыРасписание" Тогда
		
		ЭлементФормы.Доступность = Форма.ИспользоватьИнтеграциюСЯндексКассой И Форма.ПолучатьУведомленияОтЯндексКассыАвтоматически;
	...
	ИначеЕсли Идентификатор = "ИспользоватьГруппыДоступаЛидов" Тогда
		
		ЭлементФормы.Доступность = Форма.ОграничиватьДоступНаУровнеЗаписей;
		
	ИначеЕсли Идентификатор = "ОткрытьГруппыДоступаЛидов" Тогда
		
		ЭлементФормы.Доступность = Форма.ОграничиватьДоступНаУровнеЗаписей И Форма.ИспользоватьГруппыДоступаЛидов;
	...
	ИначеЕсли Идентификатор = "НастройкаОнлайнПоддержки" Тогда
		
		ЭлементФормы.Доступность = Форма.ИспользоватьОнлайнПоддержку;
	...
	ИначеЕсли Идентификатор = "НастройкаДиапазоновSKUВесовогоТовара" Тогда
