...
// со смещением в результирующем ХМL. Тем самым обходится ограничение ОбъектXDTO, который не позволяет уставливать в
...
// Обработчик подисики на событие "Перед записью" для документов, влиящий на расчет статуса поступления Заявок на выпуск
// КиЗ.
//
// Параметры:
...
// Обработчик подисики на событие "При проведении" для документов, влиящий на расчет статуса поступления Заявок на
// выпуск КиЗ.
//
// Параметры:
//  Источник        - ДокументОбъект - источник события.
...
// Обработчик подисики на событие "При записи" для документов, влиящий на расчет статуса Уведомлений о поступлении
...
// дейстие или статус не требуются.
//
// Параметры:
