...
Процедура ПроверкаЗаполненияСерийныхНомеров(Отказ, Знач Запасы, Знач СерийныеНомера, СтруктурнаяЕдиница, Знач вхФорма, ИмяПоляКлючСвязи="КлючСвязи", ИмяПоляНоменклатура = "Номенклатура", ИмяПоляСтруктурнаяЕдиница = "СтруктурнаяЕдиница") Экспорт
	...
	Если ИспользованиеСерийныхНомеров = Истина Тогда
		...
		//Если склад ордерный, движения по нему по СН делают только ПриходныйОрдер или РасходныйОрдер, для остальных документов проверять заполнение СН не нужно
		//Если склад НЕ ордерный, движения по нему по СН делают ВСЕ остальные документы, нужно проверить заполнение СН.
		//В ПриходныйОрдер или РасходныйОрдер нет складов в табличной части
