...
Процедура ПриОпределенииВидовПодключаемыхКоманд(ВидыПодключаемыхКоманд) Экспорт
	...
	ИнтеграцияСЯндексКассой.ПриОпределенииВидовПодключаемыхКоманд(ВидыПодключаемыхКоманд); //Подключение команд интеграции с Яндекс.Кассой
...
Процедура ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды) Экспорт
	...
	ИнтеграцияСЯндексКассой.ПриОпределенииКомандПодключенныхКОбъекту(НастройкиФормы, Источники, ПодключенныеОтчетыИОбработки, Команды); //Подключение команд интеграции с Яндекс.Кассой	
...
Функция УниверсальнаяСтруктураОписанияОбъектовПодключаемыхКоманд() Экспорт
	...
	ИменаДокументов.Добавить("ES_ПланДоставки");
	ИменаДокументов.Добавить("ES_Возвраты");
	// ES_Сережко А.С. 07.02.18
