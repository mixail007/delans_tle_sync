...
//   ЭлементыСКД - КоллекцияВыбранныхПолейКомпоновкиДанных, КоллекцияЭлементовОтбораКомпоновкиДанных, КоллекцияЭлементовСтруктурыНастроекКомпоновкиДанных - Коллекция элементов настроек компоновки данных
//
