...
Процедура ЗаполнитьЭквайринговыеОперации(Объект, ДатаНачала = '00010101', ДатаОкончания = '00010101', Договор = Неопределено) Экспорт
	...
	|	ВЫБОР
	|		КОГДА &ТипДокумента = ТИП(Документ.ПоступлениеНаСчет)
	...
	//Если эквайринговый терминал - в табличной части, тогда отбор по эквайринговому терминалу нужно заменить на отбор по банковскому счету
...
// Процедура выполняет общие действия перед записью документов "Расход со счета" и "Поступление на счет" с видом операции "Отчет эквайера"
//
