...
Функция ЗагрузитьРезультатОбработкиЗаявки(ЭлементОчереди, ПараметрыОбмена) Экспорт
	...
	Для Каждого СообщениеXML Из СообщенияXML Цикл
		...
		НайденныеСсылкиПриОткатеТранзации = ОбщегоНазначенияКлиентСервер.СкопироватьСтруктуру(ПараметрыОбмена.ПараметрыПреобразования.НайденныеСсылки);
		...
		Исключение
			...
			ПараметрыОбмена.ПараметрыПреобразования.НайденныеСсылки = НайденныеСсылкиПриОткатеТранзации;
...
#Область ВетеринароСопроводительныеДокументы
...
Функция ПодготовитьЗапросВетеринарноСопроводительногоДокументаПоUUID(ХозяйствующийСубъект, Предприятие, Идентификатор, ПараметрыОбмена) Экспорт
	...
	ИнтеграцияВЕТИС.ПодготовитьСообщенияКПередаче(СообщенияXML, Ложь, ПараметрыОбмена);
