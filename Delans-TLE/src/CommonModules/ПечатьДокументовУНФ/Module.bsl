...
// Параметры:
//  ПараметрыНоменклатуры - Структура - Структура с параметрами, по которым формируется представление.
//
...
Функция ПредставлениеНоменклатуры(ПараметрыНоменклатуры) Экспорт
	...
	Возврат ПолучитьПредставлениеНоменклатурыДляПечати(ПредставлениеНоменклатуры, ПредставлениеХарактеристики, ПредставлениеСерийногоНомера, ПредставлениеПартии, ПредставлениеКодаТНВЭД, НеобходимоВыделитьКакСоставНабора);
...
Функция ПолучитьПредставлениеНоменклатурыДляПечати(ПредставлениеНоменклатуры, ПредставлениеХарактеристики = "", ПредставлениеСерийногоНомера = "", ПредставлениеПартии = "", ПредставлениеКодаТНВЭД = "", НеобходимоВыделитьКакСоставНабора = Ложь) Экспорт
