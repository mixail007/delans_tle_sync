...
Процедура РассчитатьПланируемыеПлатежи(ТаблицаСчетов)
	...
	Пока ОбходПоСчетамНаОплату.Следующий() Цикл
		...
		Пока ВыборкаДетальныеЗаписи.Следующий() Цикл
			...
			Если  ТипЗнч(ВыборкаДетальныеЗаписи.СчетНаОплату) <> Тип("ДокументСсылка.РасходДСПлан")
				И ТипЗнч(ВыборкаДетальныеЗаписи.СчетНаОплату) <> Тип("ДокументСсылка.ПоступлениеДСПлан")
				И ТипЗнч(ВыборкаДетальныеЗаписи.СчетНаОплату) <> Тип("ДокументСсылка.ПеремещениеДСПлан") Тогда
