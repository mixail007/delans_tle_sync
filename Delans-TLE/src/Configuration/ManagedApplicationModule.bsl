...
// EFSOL
Перем EfsolТокен Экспорт;
Перем EfsolИДАккаунта Экспорт;
Перем EfsolИДПользователя Экспорт;
Перем EfsolФИОПользователя Экспорт;
Перем EfsolCoreHTTP Экспорт;
Перем EfsolADLHTTP Экспорт;
Перем EfsolЛогин Экспорт;
Перем EfsolПароль Экспорт; 
// EFSOL
...
Процедура ПриНачалеРаботыСистемы()
	...
	#КонецЕсли
	ES_БиллингКлиент.ПроверкаДостпуностиСервисаПриСтартеРаботыСистемыНаКлиенте();	
	ES_Delans.УстановитьИспользоватьИнструментыБухгалтера();
	ОбновитьИнтерфейс();
	// EFSOL
