...
Процедура ШапкаТабличнаяЧастьЗавершениеНаСервере(Знач Результат)
	...
	Если Объект.ПоложениеСтруктурнойЕдиницы<>Результат.ПоложениеСтруктурнойЕдиницыВСдельномНаряде Тогда
		Если Результат.ПоложениеСтруктурнойЕдиницыВСдельномНаряде=Перечисления.ПоложениеРеквизитаНаФорме.ВШапке Тогда
			Объект.СтруктурнаяЕдиница = УправлениеНебольшойФирмойПовтИсп.ПолучитьЗначениеНастройки("ОсновноеПодразделение");
			Для каждого СтрокаТабличнойЧасти Из Объект.Операции Цикл
	...
	Если Объект.ПоложениеЗаказаНаПроизводство<>Результат.ПоложениеЗаказаНаПроизводствоВДокументахОтгрузки Тогда
		Если Результат.ПоложениеЗаказаНаПроизводствоВДокументахОтгрузки=Перечисления.ПоложениеРеквизитаНаФорме.ВШапке Тогда
			Для каждого СтрокаТабличнойЧасти Из Объект.Операции Цикл
				СтрокаТабличнойЧасти.ЗаказНаПроизводство = Объект.ЗаказНаПроизводство;
			КонецЦикла;
		Иначе
			Объект.ЗаказНаПроизводство = Неопределено;
		КонецЕсли; 
...
Функция ПолучитьДанныеНоменклатураПриИзменении(СтруктураДанные)
	...
	Если СтруктураДанные.Свойство("Операция") 
		...
		СтруктураДанные.Вставить("Цена", УчетнаяЦена(СтруктураДанные.Операция, СтруктураДанные.ДатаОбработки, СтруктураДанные.ВалютаДокумента));
...
&НаСервереБезКонтекста
Функция УчетнаяЦена(Номенклатура, ДатаОбработки, ВалютаДокумента)
