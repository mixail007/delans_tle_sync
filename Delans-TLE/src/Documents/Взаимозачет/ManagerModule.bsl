...
Процедура СформироватьТаблицаДоходыИРасходыКассовыйМетод(ДокументСсылкаВзаимозачет, СтруктураДополнительныеСвойства)
	...
	Если ДокументСсылкаВзаимозачет.ВидОперации = ПредопределенноеЗначение("Перечисление.ВидыОперацийВзаимозачет.ЗачетАвансовПокупателя")
		...
		// Для операции ЗачетАвансовПокупателя выполним распределение данных таблицы ВременнаяТаблицаТаблицаДоходыИРасходыОтложенные на
		// данные таблицы ВременнаяТаблицаТаблицаДоходыИРасходыНераспределенные.
		// Это нужно сделать, т.к. в таблице ВременнаяТаблицаТаблицаДоходыИРасходыОтложенные хранится информация о направлении деятельности, а
		// в таблице ВременнаяТаблицаТаблицаДоходыИРасходыНераспределенные хранится информация о статье.
