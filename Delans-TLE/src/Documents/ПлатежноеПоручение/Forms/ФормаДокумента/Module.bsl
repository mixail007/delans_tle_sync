...
Процедура УстановитьВидимостьДокументыПланирования()
	...
	Если Объект.ВидОперации = Перечисления.ВидыОперацийПлатежноеПоручение.Покупателю
		...
		Элементы.СтатьяРасчетыПрочие.Видимость = Истина;
	...
	Иначе
		...
		Элементы.СтатьяРасчетыПрочие.Видимость = Ложь;
	КонецЕсли;
...
Процедура ДополнительныеДействияРасшифровкаПлатежа(ПриСозданииНаСервере = Ложь)
	...
	Если  Объект.ВидОперации = Перечисления.ВидыОперацийПлатежноеПоручение.Оплата
		...
		Если ПриСозданииНаСервере Тогда
			...
			ВариантЗаполненияРасшифровки = Перечисления.ВариантыЗаполненияРасшифровкиПлатежа;
...
// Открывает форму распределения платежа при выполнении команды РаспределитьСуммуПлатежа с предварительной записью документа.
//
&НаКлиенте
