...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	ПоказатьВопрос(ОписаниеОповещенияОЗавершении,
		НСтр("ru = 'Выбранный отчет о розничных продажах будет перезаполнен по данным в чеках ККМ (в т.ч. архивных). Если документ проведён, то он будет перепроведён. Продолжить?'"),
