...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	ЭтотОбъект.ДополнительныеСвойства.Вставить("ЭтоПерепроведение", ЭтотОбъект.Проведен);
...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	Если (КассаККМ.ТипКассы = Перечисления.ТипыКассККМ.ФискальныйРегистратор И ЭтотОбъект.ДополнительныеСвойства.Свойство("ЭтоПерепроведение")
		И НЕ ЭтотОбъект.ДополнительныеСвойства.ЭтоПерепроведение)
		ИЛИ (ЭтотОбъект.ДополнительныеСвойства.Свойство("ЭтоЗакрытиеСмены") И ЭтотОбъект.ДополнительныеСвойства.ЭтоЗакрытиеСмены) Тогда
		...
		// пока не решить вопрос с проведением отчета о розничных продажах.
	...
	//ЭР Несторук С.И. 11.12.2017 10:59:03 {
	Если ДополнительныеСвойства.ДляПроведения.ПолноеПроведение Тогда 
...
Процедура ДвижениеПоES_НоменклатураВЗаказах(Отказ)
	...
	|	ОтчетОРозничныхПродажахЗапасы.ES_Содержание КАК ES_Содержание
	|ПОМЕСТИТЬ ВТ_Грузы
	|ИЗ
	...
	|	ОтчетОРозничныхПродажахЗапасы.ES_Содержание
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
