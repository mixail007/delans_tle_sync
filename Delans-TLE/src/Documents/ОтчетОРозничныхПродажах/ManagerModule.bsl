...
Процедура СформироватьТаблицаЗапасы(ДокументСсылкаОтчетОРозничныхПродажах, СтруктураДополнительныеСвойства)
	...
	|	ТаблицаЗапасы.Возврат КАК Возврат,
...
Процедура СформироватьТаблицаУправленческий(ДокументСсылкаОтчетОРозничныхПродажах, СтруктураДополнительныеСвойства)
	...
	//ЭР Несторук С.И. 08.12.2017 17:48:20 {
	|	ВЫБОР КОГДА ТаблицаУправленческий.ES_ЭтоГруз ТОГДА &СчетНП ИНАЧЕ
	//}ЭР Несторук С.И.
	|	ВЫБОР
	...
	//ЭР Несторук С.И. 08.12.2017 17:48:45 {
	|	КОНЕЦ
	//}ЭР Несторук С.И.
	|	КОНЕЦ КАК СчетКт,
	|	ВЫБОР
	...
	//ЭР Несторук С.И. 08.12.2017 18:31:17 {
	|	ВЫБОР КОГДА ТаблицаУправленческий.ES_ЭтоГруз ТОГДА  ""Прием наложенных платежей"" ИНАЧЕ
	//}ЭР Несторук С.И.
	|	&ОтражениеВыручки 
	//ЭР Несторук С.И. 08.12.2017 18:37:14 {
	|	КОНЕЦ
	//}ЭР Несторук С.И.
	|	КАК Содержание
	|ИЗ
	//ЭР Несторук С.И. 08.12.2017 17:37:58 {
	//|	ВременнаяТаблицаЗапасы КАК ТаблицаУправленческий
	|   ЭР_ВременнаяТаблицаЗапасы КАК ТаблицаУправленческий
	//}ЭР Несторук С.И.
	|ГДЕ
	|	&ПолноеПроведение
	...
	|	КОНЕЦ,
	//ЭР Несторук С.И. 08.12.2017 18:31:17 {
	|	ВЫБОР КОГДА ТаблицаУправленческий.ЕстьГрузы ТОГДА  &СчетНП ИНАЧЕ
	//}ЭР Несторук С.И.
	|	ТаблицаУправленческий.КассаККМСчетУчета
	//ЭР Несторук С.И. 08.12.2017 18:35:00 {
	|	КОНЕЦ
	//}ЭР Несторук С.И.
	|	,
	//ЭР Несторук С.И. 08.12.2017 18:31:17 {
	|	ВЫБОР КОГДА ТаблицаУправленческий.ЕстьГрузы ТОГДА  НЕОПРЕДЕЛЕНО ИНАЧЕ
	//}ЭР Несторук С.И.
	|	ВЫБОР
	|		КОГДА ТаблицаУправленческий.КассаККМСчетУчета.Валютный
	|			ТОГДА ТаблицаУправленческий.ВалютаДокумента
	|		ИНАЧЕ НЕОПРЕДЕЛЕНО
	//ЭР Несторук С.И. 08.12.2017 18:59:16 {
	|	КОНЕЦ
	//}ЭР Несторук С.И.
	|	КОНЕЦ,
	//ЭР Несторук С.И. 08.12.2017 18:59:30 {
	|	ВЫБОР КОГДА ТаблицаУправленческий.ЕстьГрузы ТОГДА  0 ИНАЧЕ
	//}ЭР Несторук С.И.
	|	ВЫБОР
	|		КОГДА ТаблицаУправленческий.КассаККМСчетУчета.Валютный
	|			ТОГДА ТаблицаУправленческий.СуммаВал
	|		ИНАЧЕ 0
	//ЭР Несторук С.И. 08.12.2017 19:00:00 {
	|	КОНЕЦ
	//}ЭР Несторук С.И.	
	|	КОНЕЦ,
	|	ТаблицаУправленческий.Сумма,
...
Процедура ИнициализироватьДанныеДокумента(ДокументСсылкаОтчетОРозничныхПродажах, СтруктураДополнительныеСвойства) Экспорт
	...
	|	КОНЕЦ КАК Резерв,
	//ЭР Несторук С.И. 08.12.2017 17:00:15 {
	|	ОтчетОРозничныхПродажахЗапасы.ES_ЭтоГруз,
	//}ЭР Несторук С.И.
	|	ВЫРАЗИТЬ(ВЫБОР
	...
	//ЭР Несторук С.И. 14.04.2017 15:39:07 {
	|    И ОтчетОРозничныхПродажахЗапасы.ES_ЭтоГруз = ЛОЖЬ 
	//}ЭР Несторук С.И.
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	...
	//ЭР Несторук С.И. 08.12.2017 17:17:25 {
	|	&ЕстьГрузы КАК ЕстьГрузы,
	//}ЭР Несторук С.И.
	...
	| ;
	//ЭР Несторук С.И. 21.12.2018 11:05:25 {
	|	ВЫБРАТЬ
	|	ОтчетОРозничныхПродажахЗапасы.НомерСтроки КАК НомерСтроки,
	|	ОтчетОРозничныхПродажахЗапасы.КлючСвязи КАК КлючСвязи,
	|	ОтчетОРозничныхПродажахЗапасы.Ссылка КАК Документ,
	...
	|ГДЕ
	|	ОтчетОРозничныхПродажахЗапасы.Ссылка = &Ссылка
	|    И ОтчетОРозничныхПродажахЗапасы.ES_ЭтоГруз = ИСТИНА"; 
	//}ЭР Несторук С.И.
	...
	ЕстьГрузы = ДокументСсылкаОтчетОРозничныхПродажах.Запасы.Найти(Истина, "ES_ЭтоГруз") <> Неопределено;
...
Процедура ЗаполнитьОтчетОРозничныхПродажахПоДаннымВЧеках(ОтчетОРозничныхПродажахОбъект) Экспорт
	...
	//ЭР Несторук С.И. 14.04.2017 16:06:40 {
	|	,
	|	ЧекККМЗапасы.ES_ЭтоГруз,
	...
	|		-ЧекККМЗапасы.СуммаСкидкиНаценки,
	...
	|		-ЧекККМЗапасы.СуммаСкидкиОплатыБонусом
	//ЭР Несторук С.И. 14.04.2017 16:07:22 {
	|		,
	|		ЧекККМЗапасы.ES_ЭтоГруз,
	|		ЧекККМЗапасы.ES_Содержание
	//}ЭР Несторук С.И.
	...
	|		И ЧекККМЗапасы.Ссылка.Проведен
	|		И ЧекККМЗапасы.Ссылка.НомерЧекаККМ > 0
	|		И НЕ ЧекККМЗапасы.Ссылка.ОперацияСДенежнымиСредствами) КАК ЧекККМЗапасы
	|
	|СГРУППИРОВАТЬ ПО
	|	ЧекККМЗапасы.Номенклатура,
	|	ЧекККМЗапасы.Характеристика,
	...
	|	ЧекККМЗапасы.НоменклатураНабора,
	|	ЧекККМЗапасы.ХарактеристикаНабора,
	|	ЧекККМЗапасы.ВидСкидкиНаценки,
	|	ЧекККМЗапасы.ДокументПродажи,
	|	ЧекККМЗапасы.Контрагент
	//ЭР Несторук С.И. 28.05.2017 20:32:59 {
	|	,
	|	ЧекККМЗапасы.ES_ЭтоГруз,
	|	ЧекККМЗапасы.ES_Содержание
	//}ЭР Несторук С.И.
	...
	|	ЧекККМПродажиВозвраты.СуммаСкидкиНаценки,
	|	ЧекККМПродажиВозвраты.Ответственный,
	|	ЧекККМПродажиВозвраты.ДисконтнаяКарта,
	|	ЧекККМПродажиВозвраты.ВидСкидкиНаценки,
	|	ЧекККМПродажиВозвраты.ДокументПродажи
	|
	|ИМЕЮЩИЕ
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьНаборы") Тогда
		...
		ДобавленныеНаборы = Результат[6].Выгрузить();
	...
	Если ПолучитьФункциональнуюОпцию("ИспользоватьБонусныеПрограммы") Тогда
		НачисленияБонусов = Результат[8].Выгрузить();
