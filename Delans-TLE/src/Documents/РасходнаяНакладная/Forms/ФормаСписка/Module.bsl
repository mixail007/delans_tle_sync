...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//ЭР Несторук С.И. 21.12.2018 16:00:22 {
...
#Область ES_СлужбаДоставки
&НаСервере
Процедура ЭР_ДобавитьРеквизиты()
	
	//ЭР Несторук С.И. 31.03.2017 11:22:49 {
	Если Константы.ES_СлужбаДоставки.Получить() = Ложь Тогда
		Возврат;
	КонецЕсли;
	
	Элемент = ЭтаФорма.Элементы.Вставить("ES_ВидДоставки",Тип("ПолеФормы"),ЭтаФорма.Элементы.СписокЗаказыПокупателей);
	Элемент.Заголовок = "Вид доставки";
	Элемент.ПутьКДанным = "СписокЗаказыПокупателей.ES_ВидДоставки";
	
	Элемент = ЭтаФорма.Элементы.Вставить("ES_ДатаДоставки",Тип("ПолеФормы"),ЭтаФорма.Элементы.СписокЗаказыПокупателей);
	Элемент.Заголовок = "Дата доставки";
	Элемент.ПутьКДанным = "СписокЗаказыПокупателей.ES_ДатаДоставки";

	Элемент = ЭтаФорма.Элементы.Вставить("ES_СтатусЗаказа",Тип("ПолеФормы"),ЭтаФорма.Элементы.СписокЗаказыПокупателей);
	Элемент.Заголовок = "Статус заказа";
	Элемент.ПутьКДанным = "СписокЗаказыПокупателей.ES_СтатусЗаказа";
