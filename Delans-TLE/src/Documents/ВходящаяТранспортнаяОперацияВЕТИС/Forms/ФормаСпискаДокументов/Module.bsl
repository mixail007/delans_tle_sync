...
Процедура УстановитьВидимостьТаблицыКОформлению()
	...
	Если ТТНПродукция Тогда 
		...
		Элементы.СписокТТНКОформлениюКомандаяПанельГруппа.Видимость = Истина;
		Элементы.СписокКОформлению.Видимость                     	= Ложь;
		Элементы.СписокКОформлениюКомандаяПанельГруппа.Видимость 	= Ложь;
	Иначе 
		Элементы.СписокТТНКОформлению.Видимость                     = Ложь;
		Элементы.СписокТТНКОформлениюКомандаяПанельГруппа.Видимость = Ложь;
		Элементы.СписокКОформлению.Видимость                     	= Истина;
		Элементы.СписокКОформлениюКомандаяПанельГруппа.Видимость 	= Истина;
	КонецЕсли;
