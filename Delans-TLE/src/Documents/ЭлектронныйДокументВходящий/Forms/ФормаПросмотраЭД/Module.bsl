...
Процедура ИзменитьВидимостьДоступностьНаСервере()
	...
	ЭДОЗакрыт		= ОбменСКонтрагентамиСлужебный.ДОЗакрытПринудительно(Объект.Ссылка);
	СтатусОтклонен	= ОбменСКонтрагентамиСлужебный.ЭДОтклонен(СвойстваФайлаЭД.СтатусЭД);
	ЭтоСлужебный	= ОбменСКонтрагентамиСлужебный.ЭтоСлужебныйДокумент(ПрисоединенныйФайлСсылка);
	...
	ДОЗавершен = ОбменСКонтрагентамиСлужебный.ПроверитьСостояниеЭДО(Объект.Ссылка, СостоянияЭДОЗавершен);
...
Функция ДоступныДляПодписиСертификаты(МассивОтпечатков)
	...
	ЕстьДоступныеСертификаты = ОбменСКонтрагентамиСлужебный.ЕстьДоступныеСертификаты(МассивОтпечатков, Объект.Ссылка);
