...
Функция ЗапросНаОбъединениеЗаписейСкладскогоЖурнала(ДокументСсылка, ПараметрыПередачи, ДополнительныеПараметры)
	...
	Если Шапка.СпособОбъединения = Перечисления.СпособыОбъединенияЗаписейСкладскогоЖурналаВЕТИС.Присоединить Тогда
		...
		ЗаписьЖурнала = ИнтеграцияВЕТИС.ОбъектXDTOПоИмениТипа(ОбъединяемыеЗаписи, "sourceStockEntry");
	...
	Если Шапка.СпособОбъединения = Перечисления.СпособыОбъединенияЗаписейСкладскогоЖурналаВЕТИС.Объединить Тогда
		...
		НоваяЗаписьЖурнала = ИнтеграцияВЕТИС.ОбъектXDTOПоИмениТипа(ОбъединяемыеЗаписи, "resultStockEntry");
