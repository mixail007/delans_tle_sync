...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	Если ПараметрыВыполненияКоманды.Источник.ИмяФормы = "Справочник.Номенклатура.Форма.ФормаЭлемента" Тогда
		НоменклатураВДокументахКлиент.ПодготовитьРеквизитыСтрокиПоЭлементу(ПараметрыВыполненияКоманды, "ПриходнаяНакладная");
	Иначе
		НоменклатураВДокументахКлиент.ПодготовитьРеквизитыСтрокСписка(ПараметрыВыполненияКоманды, "ПриходнаяНакладная");
	КонецЕсли;
