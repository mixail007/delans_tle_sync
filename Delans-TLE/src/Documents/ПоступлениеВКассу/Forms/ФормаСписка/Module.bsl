...
&НаКлиенте
Процедура ПриемНаложенныхПлатежей(Команда)
	//ЕФСОЛ Несторук 18.07.2016 + 
	ДвиженияДенежныхСредствКлиент.СоздатьДокумент("ПоступлениеВКассу", "ES_ПриемНаложенныхПлатежей", ДанныеМеток);
КонецПроцедуры
