...
Процедура ТоварыПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
	...
	Если НоваяСтрока Тогда
		ЗаполнитьРеквизитыПоУмолчаниюНовойСтрокиТовары(Элементы.Товары.ТекущиеДанные);
...
&НаКлиентеНаСервереБезКонтекста
Процедура ЗаполнитьРеквизитыПоУмолчаниюНовойСтрокиТовары(СтрокаТабличнойЧасти)
