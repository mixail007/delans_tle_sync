...
Функция ЗапросНаОформлениеРезультатовИнвентаризацииXML(ДокументСсылка, ПараметрыПередачи, ДополнительныеПараметры)
	...
	// Сведения о результате инвентаризации (по одному факту расхождения).
	РезультатИнвентаризации = ИнтеграцияВЕТИС.ОбъектXDTOПоИмениТипа(ДокументXDTO, "stockDiscrepancy");
	...
	Для каждого ДанныеСтроки Из ДанныеДокумента.Товары Цикл
		...
		ЗаписьСкладскогоЖурнала = ИнтеграцияВЕТИС.ОбъектXDTOПоИмениТипа(Записи, "stockEntry");
	...
	Если ЗначениеЗаполнено(Шапка.СерияАктаНесоответствия)
		...
		АктОНесоответствии = ИнтеграцияВЕТИС.ОбъектXDTOПоИмениТипа(ДокументXDTO, "discrepancyReport");
		...
		ПричинаНесоответствия = ИнтеграцияВЕТИС.ОбъектXDTOПоИмениТипа(АктОНесоответствии, "reason");
...
Функция ТекстЗапросаТаблицаДвиженияСерийТоваров(Запрос, ТекстыЗапроса, Регистры)
	...
	ТекстЗапроса = ИнтеграцияВЕТИСПереопределяемый.ТекстЗапросаДвижениеСерийТоваров(
		Метаданные.Документы.ИнвентаризацияПродукцииВЕТИС.Имя);
...
Функция ТипДокумента()
	...
	ТипДокумента = Метаданные.Документы.ИнвентаризацияПродукцииВЕТИС;
