...
Функция ВыполнитьЭтапСдельныйНаряд(ДокументОбъект, ЗначенияПолей, Ошибки)
	...
	Для каждого СтрокаОперации Из ТаблицаОпераций Цикл
		...
		НоваяСтрокаОперация.КоличествоПлан = ЗначенияПолей.КоличествоПродукции;
		НоваяСтрокаОперация.КоличествоФакт = ЗначенияПолей.КоличествоПродукции;
		...
		// Состав бригады
		Если ТаблицаОпераций.Колонки.Найти("СоставБригады")<>Неопределено Тогда
...
Функция ОперацииЭтапа(ЗначенияПолей)
	...
	Если ЗначениеЗаполнено(ЗначенияПолей.ЗаказНаПроизводство) 
		...
		|			ИЛИ &БезЭтапов) И НЕ ЗаказНаПроизводствоОперации.Операция Есть Null
		|;
		|
		|////////////////////////////////////////////////////////////////////////////////
		|ВЫБРАТЬ
