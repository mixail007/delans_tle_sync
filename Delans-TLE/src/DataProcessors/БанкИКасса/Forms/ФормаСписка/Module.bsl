...
Процедура НастроитьПанелиОтборов()
	...
	РаботаСОтборами.НастроитьПанельОтборовМобильныйКлиент(ЭтаФорма, "ПраваяПанельПП", "ДанныеМетокПП", ОтборПП, "ДекорацияРазвернутьОтборыПП,СвернутьОтборыПП");
	РаботаСОтборами.НастроитьПанельОтборовМобильныйКлиент(ЭтаФорма, "ПраваяПанельЭ", "ДанныеМетокОплатаКартами", ОтборЭ, "ДекорацияРазвернутьОтборыЭ,СвернутьОтборыЭ");
