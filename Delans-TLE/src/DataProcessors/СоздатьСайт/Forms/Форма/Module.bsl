...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбщегоНазначения.ЭтоМобильныйКлиент() Тогда
		...
		Элементы.Декорация31.Видимость = Ложь;
...
Процедура ПометкаИерархииПриИзменении()
	...
	Если ТекущиеДанные.Представление = НСтр("ru = '<Все группы>'") Тогда
		//Все элементы дерева
		НоменклатураВДокументахКлиентСервер.УстановитьФлагУПодчиненных(ОтборИерархия.ПолучитьЭлементы(), "Флаг", ТекущиеДанные.Флаг);
	Иначе	
...
Процедура ПометкаКатегорииПриИзменении()
	...
	Если ТекущиеДанные.Значение = ПредопределенноеЗначение("Справочник.КатегорииНоменклатуры.ПустаяСсылка") Тогда
		//Все элементы дерева
		НоменклатураВДокументахКлиентСервер.УстановитьФлагУПодчиненных(ОтборКатегории.ПолучитьЭлементы(), "Флаг", ТекущиеДанные.Флаг);
	Иначе	
		НоменклатураВДокументахКлиентСервер.УстановитьФлагУПодчиненных(ТекущиеДанные.ПолучитьЭлементы(), "Флаг", ТекущиеДанные.Флаг);
		Если ТекущиеДанные.Флаг = Ложь Тогда
			НоменклатураВДокументахКлиентСервер.УстановитьФлагУРодителей(ТекущиеДанные, "Флаг", Ложь);
