...
Процедура ЗаполнитьТаблицуТоваровНаСервере(Сохранять = Истина)
	...
	Для Каждого СтрокаТЧ Из ДанныеДляПечати.ТаблицаТоваров Цикл
		...
		НоваяСтрока.ШаблонЦенника        = СтрокаТЧ[ДанныеДляПечати.СоответствиеПолейСКДКолонкамТаблицыТоваров.Получить("Номенклатура.КатегорияНоменклатуры.ШаблонЦенника")];
