...
Процедура ЗапуститьОбновлениеДанныхФормы()
	...
	ДлительныеОперацииКлиент.ОжидатьЗавершение(ДлительнаяОперация, Новый ОписаниеОповещения("ОбработатьЗавершениеФоновогоЗадания", ЭтотОбъект), ПараметрыОжидания);
	...
	Если ФоновоеЗаданиеИмя = "ФоновоеЗаданиеСозданиеПакетаДокументов" Тогда
		...
		Если Результат.Свойство("АктыВыполненныхРабот") Тогда
			...
			Если ФормированиеАктовПечатать И Результат.Свойство("АктыВыполненныхРаботИменаМакетов") Тогда
				УправлениеПечатьюКлиент.ВыполнитьКомандуПечати("Документ.АктВыполненныхРабот", Результат.АктыВыполненныхРаботИменаМакетов, Результат.АктыВыполненныхРабот, ЭтотОбъект);
			КонецЕсли;
		...
		Если Результат.Свойство("СчетаНаОплату") Тогда
			...
			Если ФормированиеСчетовПечатать И Результат.Свойство("СчетаНаОплатуИменаМакетов") Тогда
				УправлениеПечатьюКлиент.ВыполнитьКомандуПечати("Документ.СчетНаОплату", Результат.СчетаНаОплатуИменаМакетов, Результат.СчетаНаОплату, ЭтотОбъект);
			КонецЕсли;
