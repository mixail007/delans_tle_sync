...
Процедура ПриЗавершенииОбмена(Изменения, ДополнительныеПараметры) Экспорт
	...
	Если ОбщегоНазначенияКлиентСервер.ЕстьРеквизитИлиСвойствоОбъекта(Результат, "ВходящееСообщение") Тогда
		ВходящееСообщение = Результат.ВходящееСообщение;
	КонецЕсли;
	
	Если ОбщегоНазначенияКлиентСервер.ЕстьРеквизитИлиСвойствоОбъекта(Результат, "Объект") Тогда
