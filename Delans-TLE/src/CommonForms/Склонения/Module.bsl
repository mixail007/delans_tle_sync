...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// УНФ
	ИспользоватьСклонениеСредствамиПлатформы = СклонениеПредставленийОбъектов.ИспользоватьСклонениеСредствамиПлатформы();
	Если ИспользоватьСклонениеСредствамиПлатформы Тогда
		ПросклонятьПредставлениеПоВсемПадежамСредствамиПлатформы();
	КонецЕсли;
	// Конец УНФ
...
Процедура ПросклонятьПовторноНаСервере()
	...
	// УНФ
	Если СклонениеПредставленийОбъектов.ИспользоватьСклонениеСредствамиПлатформы() Тогда
...
&НаСервере
Процедура ПросклонятьПредставлениеПоВсемПадежамСредствамиПлатформы()
	
	Если НЕ ИзмененоПредставление И Склонения <> Неопределено Тогда
		Возврат;
	КонецЕсли;
	
	СтруктураСклонений = Новый Структура;
	Для каждого Падеж Из СоответствиеПадежей() Цикл
		СтруктураСклонений.Вставить(Падеж.Значение, СклонениеПредставленийОбъектов.ПросклонятьПредставление(Представление, Падеж.Ключ));
	КонецЦикла;
