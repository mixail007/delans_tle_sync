...
&НаКлиенте
Процедура СрокГодностиИнтервалДеньМесяцГодЧасЧасПриИзменении(Элемент)
...
&НаКлиенте
Процедура СрокГодностиИнтервалДеньМесяцГодЧасЧасПоПриИзменении(Элемент)
...
Процедура УстановитьВариантУказанияСрокаГодности()
	...
	ИначеЕсли ИнтеграцияВЕТИСКлиентСервер.ТочностьЗаполненияБезДаты(СпособЗаполненияПериода) Тогда
		Элементы.Страницы.ТекущаяСтраница = Элементы.ДекорацияПеречисления;
	КонецЕсли;
