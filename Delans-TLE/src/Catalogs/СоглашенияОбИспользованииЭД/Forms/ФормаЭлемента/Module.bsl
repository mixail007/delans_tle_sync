...
Процедура УправлениеФормой(Форма)
	...
	Элементы.Контрагент.ТолькоПросмотр = КонтрагентПрисоединен;
	Если КонтрагентПрисоединен Тогда
...
Процедура ВходящиеДокументыПредставлениеСпособаОбработкиНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если ТекСтрока <> Неопределено Тогда
		...
		ПоказатьВыборИзСписка(ОписаниеОповещения, СоответствиеВидовИТипов.Получить(ТекСтрока.ВходящийДокумент),
