...
Процедура ОткрытьЧерезБраузер(Команда)
	...
	Иначе 
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю(НСтр("ru = 'Идектификатор документа не заполнен!'"),,,"Объект.Идентификатор");
	КонецЕсли;
...
Процедура НастроитьЗависимыеЭлементыФормы(Форма, СписокРеквизитов = "")
	...
	Если СтруктураРеквизитов.Свойство("Продукция")
		...
		Элементы.ГруппаЖивотныеНаТерриторииТС.Видимость = Форма.ТипЖивыеЖивотные;
