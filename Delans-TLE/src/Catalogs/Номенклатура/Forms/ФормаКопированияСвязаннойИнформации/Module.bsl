...
Процедура ЗаполнитьПараметрыВыбора()
	...
	// Копирование характеристик ограничено той же категорией номенклатуры
	Если ЗначениеЗаполнено(Номенклатура) И ТребуетсяКопированиеХарактеристик Тогда
	...
	ПараметрыВыбора.Добавить(Новый ПараметрВыбора("Отбор.ТипНоменклатуры", ТипНоменклатуры));
...
Процедура ВыполнитьКопированиеДанных()
	...
	Для каждого СтрокаТабличнойЧасти Из Значения Цикл
		...
		Если СтрокаТабличнойЧасти.ТипЗначения="ЕдиницыИзмерения" Тогда
			КопироватьЕдиницуИзмерения(СтрокаТабличнойЧасти.Значение, Владельцы);
		КонецЕсли; 
...
&НаСервере
Процедура КопироватьЕдиницуИзмерения(ЕдиницаИзмерения, Владельцы)
...
Процедура ОтобразитьПодсказку(Форма)
	...
	ИначеЕсли Форма.КопироватьСпецификации Тогда
