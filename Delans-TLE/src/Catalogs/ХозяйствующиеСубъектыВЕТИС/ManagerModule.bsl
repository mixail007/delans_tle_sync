...
// 
// Параметры:
//  ОрганизацияКонтрагентВЕТИС			 - ОпределяемыйТип.ОрганизацияКонтрагентВЕТИС - организация
...
//
//
Функция ХозяйствующийСубъектИПредприятиеПоПрикладнымРеквизитам(ОрганизацияКонтрагентВЕТИС, ТорговыйПроизводственныйОбъектВЕТИС) Экспорт
	
	Если Метаданные.ОпределяемыеТипы.ТорговыйОбъектВЕТИС.Тип.СодержитТип(ТипЗнч(ТорговыйПроизводственныйОбъектВЕТИС)) Тогда
		Возврат ХозяйствующийСубъектИПредприятиеПоОрганизацииИСкладу(ОрганизацияКонтрагентВЕТИС, ТорговыйПроизводственныйОбъектВЕТИС);
	Иначе
		Возврат ХозяйствующийСубъектИПредприятиеПоОрганизацииИПодразделению(ОрганизацияКонтрагентВЕТИС, ТорговыйПроизводственныйОбъектВЕТИС);
	КонецЕсли;
...
//
// Параметры:
//  Организация	 - ОпределяемыйТип.ОрганизацияКонтрагентВЕТИС - организация
