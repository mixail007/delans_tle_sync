...
Функция СтрокаТипОперации(СтадияОперации)
	...
	Если РежимИзменения Тогда
		Если СтадияОперации = "Завершено" Тогда
			СтрокаТипОперации = НСтр("ru = 'Изменена'");
		ИначеЕсли СтадияОперации = "Ожидание" Тогда
			СтрокаТипОперации = НСтр("ru = 'изменение'");
		ИначеЕсли СтадияОперации = "Получение" Тогда
			СтрокаТипОперации = НСтр("ru = 'изменении'");
		КонецЕсли;
	Иначе
		Если СтадияОперации = "Завершено" Тогда
			СтрокаТипОперации = НСтр("ru = 'Добавлена'");
		ИначеЕсли СтадияОперации = "Ожидание" Тогда
			СтрокаТипОперации = НСтр("ru = 'добавление'");
		ИначеЕсли СтадияОперации = "Получение" Тогда
			СтрокаТипОперации = НСтр("ru = 'добавление'");
		КонецЕсли;
	КонецЕсли;
	
	Возврат СтрокаТипОперации;
