...
Процедура УправлениеВидимостьюНаСервере()
	...
	Элементы.ГруппаВидСкидки.Видимость						   = Объект.СтарыйМеханизмСкидок;
	Элементы.Скидка.Видимость								   = Объект.СтарыйМеханизмСкидок;
	Элементы.ГруппаПериодичностьНакопления.Видимость		   = Объект.СтарыйМеханизмСкидок;
	Элементы.ПорогиНакопительныхСкидок.Видимость			   = Объект.СтарыйМеханизмСкидок;
	Элементы.ВариантСовместногоПримененияСкидок.Видимость	= Не Объект.СтарыйМеханизмСкидок;
	Элементы.ПерейтиКНастройке.Видимость					= Не Объект.СтарыйМеханизмСкидок;
	Элементы.ГруппаАвтоСкидки.Видимость						= Не Объект.СтарыйМеханизмСкидок;
