...
Процедура ИзменитьПризнакОсновнаяСпецификация(Номенклатура, Характеристика, Спецификация) Экспорт
	...
	Если Менеджер.Выбран() И Менеджер.Спецификация=Спецификация Тогда
		Менеджер.Удалить();
	Иначе
		Если ОбщегоНазначения.ЗначениеРеквизитаОбъекта(Спецификация, "ПометкаУдаления") Тогда
			ТекстСообщения = НСтр("ru = 'Спецификация %1 помечена на удаление. Установка признака <основная> невозможен.'");
...
Функция РеквизитыРедактируемыеВГрупповойОбработке() Экспорт
	...
	РедактируемыеРеквизиты.Добавить("ЗаказПокупателя");
...
Процедура ОбработкаПолученияДанныхВыбора(ДанныеВыбора, Параметры, СтандартнаяОбработка)
	...
	Если Параметры.Отбор.Свойство("ХарактеристикаПродукции") Тогда
