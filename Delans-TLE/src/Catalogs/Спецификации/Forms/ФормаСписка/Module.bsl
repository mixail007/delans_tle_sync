...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если НЕ ОтображатьСпецификацииЗаказов Тогда
		УправлениеНебольшойФирмойКлиентСервер.УстановитьЭлементОтбораСписка(Список, "ЗаказПокупателя", Документы.ЗаказПокупателя.ПустаяСсылка(), 
...
Процедура ОтображатьСпецификацииЗаказовПриИзменении(Элемент)
	...
	СтруктураОтбора.Вставить("ИмяПоляОтбора", "ЗаказПокупателя");
	...
	Если НЕ ОтображатьСпецификацииЗаказов Тогда
		УправлениеНебольшойФирмойКлиентСервер.УстановитьЭлементОтбораСписка(Список, "ЗаказПокупателя", ПредопределенноеЗначение("Документ.ЗаказПокупателя.ПустаяСсылка"), 
			Истина, ВидСравненияКомпоновкиДанных.Равно);
	Иначе
		УправлениеНебольшойФирмойКлиентСервер.УдалитьЭлементОтбораСписка(Список, "ЗаказПокупателя");	
	КонецЕсли;
...
Процедура УправлениеФормой(Форма)
	...
	ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, "ГруппаОтборЗаказПокупателя", 	"Видимость", Форма.ОтображатьСпецификацииЗаказов);
